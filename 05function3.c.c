...
struct sLongNode* sLongNode_initialize(struct sLongNode* self, unsigned int value, struct sInfo* info);
...
struct sULongNode* sULongNode_initialize(struct sULongNode* self, unsigned int value, struct sInfo* info);
...
memset(&right_value4, 0, sizeof(void*));
    come_value_0=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value1=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "05function3.c", 23))));
    ...
    come_value_0->type=(struct sType*)come_increment_ref_count(((struct sType*)(right_value4=sType_initialize((struct sType*)come_increment_ref_count(((struct sType*)(right_value3=(struct sType*)come_calloc(1, sizeof(struct sType)*(1), "05function3.c", 26)))),"int",info,(_Bool)0))));
...
memset(&litem_9, 0, sizeof(struct list_item$1CVALUEph*));
        if(self->len==0) {
            litem_7=((struct list_item$1CVALUEph*)(right_value5=(struct list_item$1CVALUEph*)come_calloc(1, sizeof(struct list_item$1CVALUEph)*(1), "05function3.c", 31)));
            litem_7->prev=((void*)0);
            litem_7->next=((void*)0);
            ...
            litem_8=((struct list_item$1CVALUEph*)(right_value6=(struct list_item$1CVALUEph*)come_calloc(1, sizeof(struct list_item$1CVALUEph)*(1), "05function3.c", 41)));
            ...
            litem_9=((struct list_item$1CVALUEph*)(right_value7=(struct list_item$1CVALUEph*)come_calloc(1, sizeof(struct list_item$1CVALUEph)*(1), "05function3.c", 51)));
...
memset(&right_value13, 0, sizeof(void*));
    come_value_10=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value10=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "05function3.c", 75))));
    ...
    come_value_10->type=(struct sType*)come_increment_ref_count(((struct sType*)(right_value13=sType_initialize((struct sType*)come_increment_ref_count(((struct sType*)(right_value12=(struct sType*)come_calloc(1, sizeof(struct sType)*(1), "05function3.c", 78)))),"int",info,(_Bool)0))));
...
memset(&right_value19, 0, sizeof(void*));
    come_value_11=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value16=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "05function3.c", 117))));
    ...
    come_value_11->type=(struct sType*)come_increment_ref_count(((struct sType*)(right_value19=sType_initialize((struct sType*)come_increment_ref_count(((struct sType*)(right_value18=(struct sType*)come_calloc(1, sizeof(struct sType)*(1), "05function3.c", 120)))),"long",info,(_Bool)0))));
...
memset(&right_value25, 0, sizeof(void*));
    come_value_12=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value22=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "05function3.c", 164))));
    ...
    come_value_12->type=(struct sType*)come_increment_ref_count(((struct sType*)(right_value25=sType_initialize((struct sType*)come_increment_ref_count(((struct sType*)(right_value24=(struct sType*)come_calloc(1, sizeof(struct sType)*(1), "05function3.c", 167)))),"long",info,(_Bool)0))));
...
memset(&right_value31, 0, sizeof(void*));
    come_value_13=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value28=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "05function3.c", 211))));
    ...
    come_value_13->type=(struct sType*)come_increment_ref_count(((struct sType*)(right_value31=sType_initialize((struct sType*)come_increment_ref_count(((struct sType*)(right_value30=(struct sType*)come_calloc(1, sizeof(struct sType)*(1), "05function3.c", 214)))),"float",info,(_Bool)0))));
...
memset(&right_value37, 0, sizeof(void*));
    come_value_14=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value34=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "05function3.c", 258))));
    ...
    come_value_14->type=(struct sType*)come_increment_ref_count(((struct sType*)(right_value37=sType_initialize((struct sType*)come_increment_ref_count(((struct sType*)(right_value36=(struct sType*)come_calloc(1, sizeof(struct sType)*(1), "05function3.c", 261)))),"double",info,(_Bool)0))));
...
void* right_value88;
memset(&p2_17, 0, sizeof(char*));
memset(&c_18, 0, sizeof(char));
...
memset(&lont_22, 0, sizeof(unsigned int)); /* bbb */
memset(&value2_23, 0, sizeof(int));
memset(&right_value54, 0, sizeof(void*));
memset(&right_value55, 0, sizeof(void*));
memset(&right_value58, 0, sizeof(void*));
memset(&lont_25, 0, sizeof(unsigned int)); /* bbb */
memset(&value_26, 0, sizeof(int));
memset(&right_value59, 0, sizeof(void*));
memset(&right_value60, 0, sizeof(void*));
memset(&right_value63, 0, sizeof(void*));
memset(&value_28, 0, sizeof(unsigned int));
memset(&right_value64, 0, sizeof(void*));
memset(&right_value65, 0, sizeof(void*));
memset(&right_value68, 0, sizeof(void*));
memset(&value_30, 0, sizeof(unsigned long int));
memset(&right_value69, 0, sizeof(void*));
memset(&right_value70, 0, sizeof(void*));
memset(&right_value73, 0, sizeof(void*));
memset(&value_32, 0, sizeof(unsigned long int));
memset(&right_value74, 0, sizeof(void*));
memset(&right_value75, 0, sizeof(void*));
memset(&right_value78, 0, sizeof(void*));
memset(&value_34, 0, sizeof(unsigned long int));
memset(&right_value79, 0, sizeof(void*));
memset(&right_value80, 0, sizeof(void*));
memset(&right_value83, 0, sizeof(void*));
memset(&lont_36, 0, sizeof(unsigned int)); /* bbb */
        ...
        if(*info->p==46&&xisdigit(c_18)) {
            ...
            *p2_17=0;
            ...
            if(*info->p==102||*info->p==70) {
                info->p++;
                skip_spaces_and_lf(info);
                _inf_value1=(struct sNode*)come_calloc(1, sizeof(struct sNode), "05function3.c", 397);
                _inf_obj_value1=come_increment_ref_count(((struct sFloatNode*)(right_value40=sFloatNode_initialize((struct sFloatNode*)come_increment_ref_count(((struct sFloatNode*)(right_value39=(struct sFloatNode*)come_calloc(1, sizeof(struct sFloatNode)*(1), "05function3.c", 397)))),strtof(buf_16,((void*)0)),info))));
                ...
                info->p++;
                skip_spaces_and_lf(info);
                _inf_value2=(struct sNode*)come_calloc(1, sizeof(struct sNode), "05function3.c", 403);
                _inf_obj_value2=come_increment_ref_count(((struct sDoubleNode*)(right_value45=sDoubleNode_initialize((struct sDoubleNode*)come_increment_ref_count(((struct sDoubleNode*)(right_value44=(struct sDoubleNode*)come_calloc(1, sizeof(struct sDoubleNode)*(1), "05function3.c", 403)))),strtod(buf_16,((void*)0)),info))));
                ...
                _inf_value3=(struct sNode*)come_calloc(1, sizeof(struct sNode), "05function3.c", 406);
                _inf_obj_value3=come_increment_ref_count(((struct sDoubleNode*)(right_value50=sDoubleNode_initialize((struct sDoubleNode*)come_increment_ref_count(((struct sDoubleNode*)(right_value49=(struct sDoubleNode*)come_calloc(1, sizeof(struct sDoubleNode)*(1), "05function3.c", 406)))),strtod(buf_16,((void*)0)),info))));
            ...
            if(*info->p==76||*info->p==108) {
                ...
                if(*info->p==76||*info->p==108) {
                    ...
                    _inf_value4=(struct sNode*)come_calloc(1, sizeof(struct sNode), "05function3.c", 426);
                    _inf_obj_value4=come_increment_ref_count(((struct sULongNode*)(right_value55=sULongNode_initialize((struct sULongNode*)come_increment_ref_count(((struct sULongNode*)(right_value54=(struct sULongNode*)come_calloc(1, sizeof(struct sULongNode)*(1), "05function3.c", 426)))),value2_23,info))));
                    ...
                    _inf_value5=(struct sNode*)come_calloc(1, sizeof(struct sNode), "05function3.c", 430);
                    _inf_obj_value5=come_increment_ref_count(((struct sULongNode*)(right_value60=sULongNode_initialize((struct sULongNode*)come_increment_ref_count(((struct sULongNode*)(right_value59=(struct sULongNode*)come_calloc(1, sizeof(struct sULongNode)*(1), "05function3.c", 430)))),value_26,info))));
                ...
                _inf_value6=(struct sNode*)come_calloc(1, sizeof(struct sNode), "05function3.c", 435);
                _inf_obj_value6=come_increment_ref_count(((struct sUIntNode*)(right_value65=sUIntNode_initialize((struct sUIntNode*)come_increment_ref_count(((struct sUIntNode*)(right_value64=(struct sUIntNode*)come_calloc(1, sizeof(struct sUIntNode)*(1), "05function3.c", 435)))),value_28,info))));
            ...
            if(*info->p==76||*info->p==108) {
                ...
                _inf_value7=(struct sNode*)come_calloc(1, sizeof(struct sNode), "05function3.c", 449);
                _inf_obj_value7=come_increment_ref_count(((struct sLongNode*)(right_value70=sLongNode_initialize((struct sLongNode*)come_increment_ref_count(((struct sLongNode*)(right_value69=(struct sLongNode*)come_calloc(1, sizeof(struct sLongNode)*(1), "05function3.c", 449)))),value_30,info))));
                ...
                _inf_value8=(struct sNode*)come_calloc(1, sizeof(struct sNode), "05function3.c", 458);
                _inf_obj_value8=come_increment_ref_count(((struct sULongNode*)(right_value75=sULongNode_initialize((struct sULongNode*)come_increment_ref_count(((struct sULongNode*)(right_value74=(struct sULongNode*)come_calloc(1, sizeof(struct sULongNode)*(1), "05function3.c", 458)))),value_32,info))));
                ...
                _inf_value9=(struct sNode*)come_calloc(1, sizeof(struct sNode), "05function3.c", 462);
                _inf_obj_value9=come_increment_ref_count(((struct sLongNode*)(right_value80=sLongNode_initialize((struct sLongNode*)come_increment_ref_count(((struct sLongNode*)(right_value79=(struct sLongNode*)come_calloc(1, sizeof(struct sLongNode)*(1), "05function3.c", 462)))),value_34,info))));
            ...
            _inf_value10=(struct sNode*)come_calloc(1, sizeof(struct sNode), "05function3.c", 467);
            _inf_obj_value10=come_increment_ref_count(((struct sIntNode*)(right_value85=sIntNode_initialize((struct sIntNode*)come_increment_ref_count(((struct sIntNode*)(right_value84=(struct sIntNode*)come_calloc(1, sizeof(struct sIntNode)*(1), "05function3.c", 467)))),value_37,info))));
...
memset(&result_19, 0, sizeof(struct sFloatNode*));
memset(&right_value42, 0, sizeof(void*));
                    if(self==(void*)0) {
                        struct sFloatNode* __result37__ = (void*)0;
                        return __result37__;
                    }
                    result_19=(struct sFloatNode*)come_increment_ref_count(((struct sFloatNode*)(right_value41=(struct sFloatNode*)come_calloc(1, sizeof(struct sFloatNode)*(1), "05function3.c", 399))));
...
memset(&result_21, 0, sizeof(struct sDoubleNode*));
memset(&right_value52, 0, sizeof(void*));
                    if(self==(void*)0) {
                        struct sDoubleNode* __result43__ = (void*)0;
                        return __result43__;
                    }
                    result_21=(struct sDoubleNode*)come_increment_ref_count(((struct sDoubleNode*)(right_value51=(struct sDoubleNode*)come_calloc(1, sizeof(struct sDoubleNode)*(1), "05function3.c", 408))));
...
memset(&right_value93, 0, sizeof(void*));
    _inf_value11=(struct sNode*)come_calloc(1, sizeof(struct sNode), "05function3.c", 480);
    _inf_obj_value11=come_increment_ref_count(((struct sIntNode*)(right_value90=sIntNode_initialize((struct sIntNode*)come_increment_ref_count(((struct sIntNode*)(right_value89=(struct sIntNode*)come_calloc(1, sizeof(struct sIntNode)*(1), "05function3.c", 480)))),value,info))));
...
void* right_value163;
memset(&buf_size_40, 0, sizeof(int));
memset(&p_42, 0, sizeof(char*));
memset(&value_43, 0, sizeof(unsigned long int));
...
memset(&value_46, 0, sizeof(unsigned long int));
...
memset(&value_49, 0, sizeof(unsigned int));
...
memset(&value_52, 0, sizeof(unsigned long int));
...
memset(&value_55, 0, sizeof(unsigned long int));
...
memset(&value_58, 0, sizeof(unsigned long int));
...
memset(&value_61, 0, sizeof(unsigned long int));
    ...
    if(*info->p==117||*info->p==85) {
        ...
        if(*info->p==76||*info->p==108) {
            ...
            if(*info->p==76||*info->p==108) {
                ...
                if(minus) {
                    _inf_value12=(struct sNode*)come_calloc(1, sizeof(struct sNode), "05function3.c", 528);
                    _inf_obj_value12=come_increment_ref_count(((struct sULongNode*)(right_value95=sULongNode_initialize((struct sULongNode*)come_increment_ref_count(((struct sULongNode*)(right_value94=(struct sULongNode*)come_calloc(1, sizeof(struct sULongNode)*(1), "05function3.c", 528)))),-value_43,info))));
                    ...
                    _inf_value13=(struct sNode*)come_calloc(1, sizeof(struct sNode), "05function3.c", 531);
                    _inf_obj_value13=come_increment_ref_count(((struct sULongNode*)(right_value100=sULongNode_initialize((struct sULongNode*)come_increment_ref_count(((struct sULongNode*)(right_value99=(struct sULongNode*)come_calloc(1, sizeof(struct sULongNode)*(1), "05function3.c", 531)))),value_43,info))));
                ...
                if(minus) {
                    _inf_value14=(struct sNode*)come_calloc(1, sizeof(struct sNode), "05function3.c", 538);
                    _inf_obj_value14=come_increment_ref_count(((struct sULongNode*)(right_value105=sULongNode_initialize((struct sULongNode*)come_increment_ref_count(((struct sULongNode*)(right_value104=(struct sULongNode*)come_calloc(1, sizeof(struct sULongNode)*(1), "05function3.c", 538)))),-value_46,info))));
                    ...
                    _inf_value15=(struct sNode*)come_calloc(1, sizeof(struct sNode), "05function3.c", 541);
                    _inf_obj_value15=come_increment_ref_count(((struct sULongNode*)(right_value110=sULongNode_initialize((struct sULongNode*)come_increment_ref_count(((struct sULongNode*)(right_value109=(struct sULongNode*)come_calloc(1, sizeof(struct sULongNode)*(1), "05function3.c", 541)))),value_46,info))));
            ...
            if(minus) {
                _inf_value16=(struct sNode*)come_calloc(1, sizeof(struct sNode), "05function3.c", 549);
                _inf_obj_value16=come_increment_ref_count(((struct sUIntNode*)(right_value115=sUIntNode_initialize((struct sUIntNode*)come_increment_ref_count(((struct sUIntNode*)(right_value114=(struct sUIntNode*)come_calloc(1, sizeof(struct sUIntNode)*(1), "05function3.c", 549)))),-value_49,info))));
                ...
                _inf_value17=(struct sNode*)come_calloc(1, sizeof(struct sNode), "05function3.c", 552);
                _inf_obj_value17=come_increment_ref_count(((struct sUIntNode*)(right_value120=sUIntNode_initialize((struct sUIntNode*)come_increment_ref_count(((struct sUIntNode*)(right_value119=(struct sUIntNode*)come_calloc(1, sizeof(struct sUIntNode)*(1), "05function3.c", 552)))),value_49,info))));
        ...
        if(*info->p==76||*info->p==108) {
            ...
            if(minus) {
                _inf_value18=(struct sNode*)come_calloc(1, sizeof(struct sNode), "05function3.c", 567);
                _inf_obj_value18=come_increment_ref_count(((struct sLongNode*)(right_value125=sLongNode_initialize((struct sLongNode*)come_increment_ref_count(((struct sLongNode*)(right_value124=(struct sLongNode*)come_calloc(1, sizeof(struct sLongNode)*(1), "05function3.c", 567)))),-value_52,info))));
                ...
                _inf_value19=(struct sNode*)come_calloc(1, sizeof(struct sNode), "05function3.c", 570);
                _inf_obj_value19=come_increment_ref_count(((struct sLongNode*)(right_value130=sLongNode_initialize((struct sLongNode*)come_increment_ref_count(((struct sLongNode*)(right_value129=(struct sLongNode*)come_calloc(1, sizeof(struct sLongNode)*(1), "05function3.c", 570)))),value_52,info))));
            ...
            if(minus) {
                _inf_value20=(struct sNode*)come_calloc(1, sizeof(struct sNode), "05function3.c", 580);
                _inf_obj_value20=come_increment_ref_count(((struct sULongNode*)(right_value135=sULongNode_initialize((struct sULongNode*)come_increment_ref_count(((struct sULongNode*)(right_value134=(struct sULongNode*)come_calloc(1, sizeof(struct sULongNode)*(1), "05function3.c", 580)))),-value_55,info))));
                ...
                _inf_value21=(struct sNode*)come_calloc(1, sizeof(struct sNode), "05function3.c", 583);
                _inf_obj_value21=come_increment_ref_count(((struct sULongNode*)(right_value140=sULongNode_initialize((struct sULongNode*)come_increment_ref_count(((struct sULongNode*)(right_value139=(struct sULongNode*)come_calloc(1, sizeof(struct sULongNode)*(1), "05function3.c", 583)))),value_55,info))));
            ...
            if(minus) {
                _inf_value22=(struct sNode*)come_calloc(1, sizeof(struct sNode), "05function3.c", 589);
                _inf_obj_value22=come_increment_ref_count(((struct sLongNode*)(right_value145=sLongNode_initialize((struct sLongNode*)come_increment_ref_count(((struct sLongNode*)(right_value144=(struct sLongNode*)come_calloc(1, sizeof(struct sLongNode)*(1), "05function3.c", 589)))),-value_58,info))));
                ...
                _inf_value23=(struct sNode*)come_calloc(1, sizeof(struct sNode), "05function3.c", 592);
                _inf_obj_value23=come_increment_ref_count(((struct sLongNode*)(right_value150=sLongNode_initialize((struct sLongNode*)come_increment_ref_count(((struct sLongNode*)(right_value149=(struct sLongNode*)come_calloc(1, sizeof(struct sLongNode)*(1), "05function3.c", 592)))),value_58,info))));
        ...
        if(minus) {
            _inf_value24=(struct sNode*)come_calloc(1, sizeof(struct sNode), "05function3.c", 599);
            _inf_obj_value24=come_increment_ref_count(((struct sIntNode*)(right_value155=sIntNode_initialize((struct sIntNode*)come_increment_ref_count(((struct sIntNode*)(right_value154=(struct sIntNode*)come_calloc(1, sizeof(struct sIntNode)*(1), "05function3.c", 599)))),-value_61,info))));
            ...
            _inf_value25=(struct sNode*)come_calloc(1, sizeof(struct sNode), "05function3.c", 602);
            _inf_obj_value25=come_increment_ref_count(((struct sIntNode*)(right_value160=sIntNode_initialize((struct sIntNode*)come_increment_ref_count(((struct sIntNode*)(right_value159=(struct sIntNode*)come_calloc(1, sizeof(struct sIntNode)*(1), "05function3.c", 602)))),value_61,info))));
...
int buf_size_64;
char* p_66;
unsigned long int value_67;
void* right_value164;
void* right_value165;
struct sNode* _inf_value26;
struct sULongNode* _inf_obj_value26;
void* right_value168;
unsigned long int value_69;
void* right_value169;
void* right_value170;
...
void* right_value178;
unsigned long int value_73;
void* right_value179;
void* right_value180;
struct sNode* _inf_value29;
struct sLongNode* _inf_obj_value29;
void* right_value183;
unsigned long int value_75;
void* right_value184;
void* right_value185;
struct sNode* _inf_value30;
struct sULongNode* _inf_obj_value30;
void* right_value188;
unsigned long int value_77;
void* right_value189;
void* right_value190;
struct sNode* _inf_value31;
struct sLongNode* _inf_obj_value31;
void* right_value193;
unsigned long int value_79;
void* right_value194;
void* right_value195;
struct sNode* _inf_value32;
struct sIntNode* _inf_obj_value32;
void* right_value198;
memset(&buf_size_64, 0, sizeof(int));
memset(&p_66, 0, sizeof(char*));
memset(&value_67, 0, sizeof(unsigned long int));
memset(&right_value164, 0, sizeof(void*));
memset(&right_value165, 0, sizeof(void*));
memset(&right_value168, 0, sizeof(void*));
memset(&value_69, 0, sizeof(unsigned long int));
memset(&right_value169, 0, sizeof(void*));
memset(&right_value170, 0, sizeof(void*));
memset(&right_value173, 0, sizeof(void*));
memset(&value_71, 0, sizeof(unsigned int));
memset(&right_value174, 0, sizeof(void*));
memset(&right_value175, 0, sizeof(void*));
memset(&right_value178, 0, sizeof(void*));
memset(&value_73, 0, sizeof(unsigned long int));
memset(&right_value179, 0, sizeof(void*));
memset(&right_value180, 0, sizeof(void*));
memset(&right_value183, 0, sizeof(void*));
memset(&value_75, 0, sizeof(unsigned long int));
memset(&right_value184, 0, sizeof(void*));
memset(&right_value185, 0, sizeof(void*));
memset(&right_value188, 0, sizeof(void*));
memset(&value_77, 0, sizeof(unsigned long int));
memset(&right_value189, 0, sizeof(void*));
memset(&right_value190, 0, sizeof(void*));
memset(&right_value193, 0, sizeof(void*));
memset(&value_79, 0, sizeof(unsigned long int));
    ...
    if(*info->p==117||*info->p==85) {
        ...
        if(*info->p==76||*info->p==108) {
            ...
            if(*info->p==76||*info->p==108) {
                ...
                _inf_value26=(struct sNode*)come_calloc(1, sizeof(struct sNode), "05function3.c", 653);
                _inf_obj_value26=come_increment_ref_count(((struct sULongNode*)(right_value165=sULongNode_initialize((struct sULongNode*)come_increment_ref_count(((struct sULongNode*)(right_value164=(struct sULongNode*)come_calloc(1, sizeof(struct sULongNode)*(1), "05function3.c", 653)))),value_67,info))));
                ...
                _inf_value27=(struct sNode*)come_calloc(1, sizeof(struct sNode), "05function3.c", 657);
                _inf_obj_value27=come_increment_ref_count(((struct sULongNode*)(right_value170=sULongNode_initialize((struct sULongNode*)come_increment_ref_count(((struct sULongNode*)(right_value169=(struct sULongNode*)come_calloc(1, sizeof(struct sULongNode)*(1), "05function3.c", 657)))),value_69,info))));
            ...
            _inf_value28=(struct sNode*)come_calloc(1, sizeof(struct sNode), "05function3.c", 662);
            _inf_obj_value28=come_increment_ref_count(((struct sUIntNode*)(right_value175=sUIntNode_initialize((struct sUIntNode*)come_increment_ref_count(((struct sUIntNode*)(right_value174=(struct sUIntNode*)come_calloc(1, sizeof(struct sUIntNode)*(1), "05function3.c", 662)))),value_71,info))));
        ...
        if(*info->p==76||*info->p==108) {
            ...
            _inf_value29=(struct sNode*)come_calloc(1, sizeof(struct sNode), "05function3.c", 675);
            _inf_obj_value29=come_increment_ref_count(((struct sLongNode*)(right_value180=sLongNode_initialize((struct sLongNode*)come_increment_ref_count(((struct sLongNode*)(right_value179=(struct sLongNode*)come_calloc(1, sizeof(struct sLongNode)*(1), "05function3.c", 675)))),value_73,info))));
            ...
            _inf_value30=(struct sNode*)come_calloc(1, sizeof(struct sNode), "05function3.c", 683);
            _inf_obj_value30=come_increment_ref_count(((struct sULongNode*)(right_value185=sULongNode_initialize((struct sULongNode*)come_increment_ref_count(((struct sULongNode*)(right_value184=(struct sULongNode*)come_calloc(1, sizeof(struct sULongNode)*(1), "05function3.c", 683)))),value_75,info))));
            ...
            _inf_value31=(struct sNode*)come_calloc(1, sizeof(struct sNode), "05function3.c", 687);
            _inf_obj_value31=come_increment_ref_count(((struct sLongNode*)(right_value190=sLongNode_initialize((struct sLongNode*)come_increment_ref_count(((struct sLongNode*)(right_value189=(struct sLongNode*)come_calloc(1, sizeof(struct sLongNode)*(1), "05function3.c", 687)))),value_77,info))));
        ...
        _inf_value32=(struct sNode*)come_calloc(1, sizeof(struct sNode), "05function3.c", 692);
        _inf_obj_value32=come_increment_ref_count(((struct sIntNode*)(right_value195=sIntNode_initialize((struct sIntNode*)come_increment_ref_count(((struct sIntNode*)(right_value194=(struct sIntNode*)come_calloc(1, sizeof(struct sIntNode)*(1), "05function3.c", 692)))),value_79,info))));
...
memset(&result_72, 0, sizeof(struct sUIntNode*));
memset(&right_value177, 0, sizeof(void*));
                if(self==(void*)0) {
                    struct sUIntNode* __result120__ = (void*)0;
                    return __result120__;
                }
                result_72=(struct sUIntNode*)come_increment_ref_count(((struct sUIntNode*)(right_value176=(struct sUIntNode*)come_calloc(1, sizeof(struct sUIntNode)*(1), "05function3.c", 664))));
...
memset(&result_76, 0, sizeof(struct sULongNode*));
memset(&right_value187, 0, sizeof(void*));
                if(self==(void*)0) {
                    struct sULongNode* __result126__ = (void*)0;
                    return __result126__;
                }
                result_76=(struct sULongNode*)come_increment_ref_count(((struct sULongNode*)(right_value186=(struct sULongNode*)come_calloc(1, sizeof(struct sULongNode)*(1), "05function3.c", 685))));
...
memset(&result_78, 0, sizeof(struct sLongNode*));
memset(&right_value192, 0, sizeof(void*));
                if(self==(void*)0) {
                    struct sLongNode* __result129__ = (void*)0;
                    return __result129__;
                }
                result_78=(struct sLongNode*)come_increment_ref_count(((struct sLongNode*)(right_value191=(struct sLongNode*)come_calloc(1, sizeof(struct sLongNode)*(1), "05function3.c", 689))));
...
memset(&result_80, 0, sizeof(struct sIntNode*));
memset(&right_value197, 0, sizeof(void*));
            if(self==(void*)0) {
                struct sIntNode* __result132__ = (void*)0;
                return __result132__;
            }
            result_80=(struct sIntNode*)come_increment_ref_count(((struct sIntNode*)(right_value196=(struct sIntNode*)come_calloc(1, sizeof(struct sIntNode)*(1), "05function3.c", 694))));
