        ...
        if(*info->p == '.' && xisdigit(c)) {
            ...
            *p2 = 0;
            ...
            if(*info->p == 'f' || *info->p == 'F') {
                ...
                return new sNode(new sFloatNode(strtof(buf, 
# 397 "05function3.c" 3 4
                                                           ((void *)0)
# 397 "05function3.c"
                                                               ), info));
            }
                ...
                return new sNode(new sDoubleNode(strtod(buf, 
# 403 "05function3.c" 3 4
                                                            ((void *)0)
# 403 "05function3.c"
                                                                ), info));
            }
        ...
        else if(*info->p == 'u' || *info->p == 'U')
        {
            ...
            if(*info->p == 'L' || *info->p == 'l')
            {
                ...
                if(*info->p == 'L' || *info->p == 'l')
                {
                    ...
                    unsigned long lont int value2 = strtoull(buf, 
# 424 "05function3.c" 3 4
                                                                 ((void *)0)
# 424 "05function3.c"
                                                                     , 0);
                    ...
                    unsigned long lont int value = strtoull(buf, 
# 429 "05function3.c" 3 4
                                                                ((void *)0)
# 429 "05function3.c"
                                                                    , 0);
                ...
                unsigned int value = strtoul(buf, 
# 434 "05function3.c" 3 4
                                                 ((void *)0)
# 434 "05function3.c"
                                                     , 0);
            ...
            if(*info->p == 'L' || *info->p == 'l')
            {
                ...
                unsigned long long int value = strtoull(buf, 
# 447 "05function3.c" 3 4
                                                            ((void *)0)
# 447 "05function3.c"
                                                                , 0);
...
# 461 "05function3.c"
            ...
            unsigned long lont int value = strtoll(buf, 
# 466 "05function3.c" 3 4
                                                       ((void *)0)
# 466 "05function3.c"
                                                           , 0);
...
# 535 "05function3.c"
            ...
            unsigned int value = strtoull(buf, 
# 546 "05function3.c" 3 4
                                              ((void *)0)
# 546 "05function3.c"
                                                  , 0);
...
# 587 "05function3.c"
        ...
        unsigned long long int value = strtoll(buf, 
# 597 "05function3.c" 3 4
                                                   ((void *)0)
# 597 "05function3.c"
                                                       , 0);
        if(minus) {
