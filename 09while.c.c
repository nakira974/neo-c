...
memset(&right_value58, 0, sizeof(void*));
    ...
    struct sWhileNode* __result46__ = self;
    if(self) { come_call_finalizer(sWhileNode_finalize,self, (void*)0, (void*)0, 0, 0, 1); }
...
memset(&result_0, 0, sizeof(struct sNode*));
        ...
        result_0=(struct sNode*)come_increment_ref_count(((struct sNode*)(right_value1=(struct sNode*)come_calloc(1, sizeof(struct sNode)*(1), "09while.c", 20))));
...
memset(&right_value57, 0, sizeof(void*));
        ...
        result_1=(struct sBlock*)come_increment_ref_count(((struct sBlock*)(right_value3=(struct sBlock*)come_calloc(1, sizeof(struct sBlock)*(1), "09while.c", 21))));
...
memset(&right_value9, 0, sizeof(void*));
                ...
                result_4=(struct list$1sNodeph*)come_increment_ref_count(((struct list$1sNodeph*)(right_value5=list$1sNodephp_initialize((struct list$1sNodeph*)come_increment_ref_count(((struct list$1sNodeph*)(right_value4=(struct list$1sNodeph*)come_calloc(1, sizeof(struct list$1sNodeph)*(1), "09while.c", 26))))))));
...
memset(&litem_8, 0, sizeof(struct list_item$1sNodeph*));
                        if(self->len==0) {
                            litem_6=((struct list_item$1sNodeph*)(right_value6=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "09while.c", 32)));
                            litem_6->prev=((void*)0);
                            litem_6->next=((void*)0);
                            ...
                            litem_7=((struct list_item$1sNodeph*)(right_value7=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "09while.c", 42)));
                            ...
                            litem_8=((struct list_item$1sNodeph*)(right_value8=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "09while.c", 52)));
...
memset(&right_value56, 0, sizeof(void*));
                ...
                result_9=(struct sVarTable*)come_increment_ref_count(((struct sVarTable*)(right_value11=(struct sVarTable*)come_calloc(1, sizeof(struct sVarTable)*(1), "09while.c", 25))));
...
memset(&right_value17, 0, sizeof(void*));
                            self->keys=((char**)(right_value13=(char**)come_calloc(1, sizeof(char*)*(1*(1024)), "09while.c", 31)));
                            self->items=((struct sVar**)(right_value14=(struct sVar**)come_calloc(1, sizeof(struct sVar*)*(1*(1024)), "09while.c", 32)));
                            self->item_existance=((_Bool*)(right_value15=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(1024)), "09while.c", 33)));
                            for(
                            i_10=0;
                            i_10<1024;
                            i_10++
                            ...
                            self->key_list=(struct list$1charp*)come_increment_ref_count(((struct list$1charp*)(right_value17=list$1charpp_initialize((struct list$1charp*)come_increment_ref_count(((struct list$1charp*)(right_value16=(struct list$1charp*)come_calloc(1, sizeof(struct list$1charp)*(1), "09while.c", 43))))))));
...
memset(&default_value_37, 0, sizeof(struct sVar*)); /* bbb */
                                            ...
                                            keys_28=((char**)(right_value19=(char**)come_calloc(1, sizeof(char*)*(1*(size_27)), "09while.c", 41)));
                                            items_29=((struct sVar**)(right_value20=(struct sVar**)come_calloc(1, sizeof(struct sVar*)*(1*(size_27)), "09while.c", 42)));
                                            item_existance_30=((_Bool*)(right_value21=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_27)), "09while.c", 43)));
                                            len_31=0;
                                            for(
...
memset(&litem_62, 0, sizeof(struct list_item$1charp*));
                                            if(self->len==0) {
                                                litem_60=((struct list_item$1charp*)(right_value22=(struct list_item$1charp*)come_calloc(1, sizeof(struct list_item$1charp)*(1), "09while.c", 110)));
                                                ...
                                                litem_61=((struct list_item$1charp*)(right_value23=(struct list_item$1charp*)come_calloc(1, sizeof(struct list_item$1charp)*(1), "09while.c", 120)));
                                                ...
                                                litem_62=((struct list_item$1charp*)(right_value24=(struct list_item$1charp*)come_calloc(1, sizeof(struct list_item$1charp)*(1), "09while.c", 130)));
...
memset(&right_value53, 0, sizeof(void*));
                                    ...
                                    result_63=(struct sVar*)come_increment_ref_count(((struct sVar*)(right_value27=(struct sVar*)come_calloc(1, sizeof(struct sVar)*(1), "09while.c", 42))));
                                    if(self!=((void*)0)&&self->mName!=((void*)0)) {
...
memset(&right_value52, 0, sizeof(void*));
                                            ...
                                            result_64=(struct sType*)come_increment_ref_count(((struct sType*)(right_value30=(struct sType*)come_calloc(1, sizeof(struct sType)*(1), "09while.c", 47))));
                                            if(self!=((void*)0)) {
...
memset(&right_value32, 0, sizeof(void*));
                                                    ...
                                                    result_65=(struct tuple1$1sTypeph*)come_increment_ref_count(((struct tuple1$1sTypeph*)(right_value31=(struct tuple1$1sTypeph*)come_calloc(1, sizeof(struct tuple1$1sTypeph)*(1), "09while.c", 51))));
                                                    if(self!=((void*)0)&&self->v1!=((void*)0)) {
...
memset(&right_value40, 0, sizeof(void*));
                                                    ...
                                                    result_66=(struct list$1sTypeph*)come_increment_ref_count(((struct list$1sTypeph*)(right_value36=list$1sTypephp_initialize((struct list$1sTypeph*)come_increment_ref_count(((struct list$1sTypeph*)(right_value35=(struct list$1sTypeph*)come_calloc(1, sizeof(struct list$1sTypeph)*(1), "09while.c", 55))))))));
...
memset(&litem_70, 0, sizeof(struct list_item$1sTypeph*));
                                                            if(self->len==0) {
                                                                litem_68=((struct list_item$1sTypeph*)(right_value37=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "09while.c", 61)));
                                                                ...
                                                                litem_69=((struct list_item$1sTypeph*)(right_value38=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "09while.c", 71)));
                                                                ...
                                                                litem_70=((struct list_item$1sTypeph*)(right_value39=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "09while.c", 81)));
...
memset(&right_value49, 0, sizeof(void*));
                                                    ...
                                                    result_71=(struct list$1charph*)come_increment_ref_count(((struct list$1charph*)(right_value45=list$1charphp_initialize((struct list$1charph*)come_increment_ref_count(((struct list$1charph*)(right_value44=(struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "09while.c", 59))))))));
...
memset(&litem_75, 0, sizeof(struct list_item$1charph*));
                                                            if(self->len==0) {
                                                                litem_73=((struct list_item$1charph*)(right_value46=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "09while.c", 65)));
                                                                ...
                                                                litem_74=((struct list_item$1charph*)(right_value47=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "09while.c", 75)));
                                                                ...
                                                                litem_75=((struct list_item$1charph*)(right_value48=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "09while.c", 85)));
...
memset(&block_78, 0, sizeof(struct sBlock*));
    ...
    if(!expression_node_76->compile(expression_node_76->_protocol_obj,info)) {
        _Bool __result48__ = (_Bool)0;
        return __result48__;
    }
    conditional_value_77=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value59=get_value_from_stack(-1,info))));
    if(right_value59) { come_call_finalizer(CVALUE_finalize,right_value59, (void*)0, (void*)0, 0, 1, 0); }
    dec_stack_ptr(1,info);
    free_right_value_objects(info);
    block_78=self->mBlock;
    add_come_code(info,"while(%s) {\n",conditional_value_77->c_value);
    transpile_block(block_78,((void*)0),((void*)0),info,(_Bool)0);
    add_come_code(info,"}\n");
    transpiler_clear_last_code(info);
    _Bool __result49__ = (_Bool)1;
    if(conditional_value_77) { come_call_finalizer(CVALUE_finalize,conditional_value_77, (void*)0, (void*)0, 0, 0, 0); }
    return __result49__;
}
...
memset(&right_value71, 0, sizeof(void*));
    if(charp_operator_equals(buf,"while")) {
        ...
        expression_node_81=(struct sNode*)come_increment_ref_count(((struct sNode*)(right_value62=expression_v13(info))));
        ...
        block_82=(struct sBlock*)come_increment_ref_count(((struct sBlock*)(right_value63=parse_block(info,(_Bool)0))));
        if(right_value63) { come_call_finalizer(sBlock_finalize,right_value63, (void*)0, (void*)0, 0, 1, 0); }
        _inf_value1=(struct sNode*)come_calloc(1, sizeof(struct sNode), "09while.c", 81);
        _inf_obj_value1=come_increment_ref_count(((struct sWhileNode*)(right_value65=sWhileNode_initialize((struct sWhileNode*)come_increment_ref_count(((struct sWhileNode*)(right_value64=(struct sWhileNode*)come_calloc(1, sizeof(struct sWhileNode)*(1), "09while.c", 81)))),(struct sNode*)come_increment_ref_count(expression_node_81),block_82,info))));
        _inf_value1->_protocol_obj=_inf_obj_value1;
        _inf_value1->finalize=sWhileNode_finalize;
        _inf_value1->clone=sWhileNode_clone;
        _inf_value1->compile=sWhileNode_compile;
        _inf_value1->sline=sWhileNode_sline;
        _inf_value1->sname=sWhileNode_sname;
        _inf_value1->terminated=sWhileNode_terminated;
        struct sNode* __result54__ = ((struct sNode*)(right_value70=_inf_value1));
        if(sname_79) { sname_79 = come_decrement_ref_count(sname_79, (void*)0, (void*)0, 0, 0); }
        if(expression_node_81) { expression_node_81 = come_decrement_ref_count(expression_node_81, ((struct sNode*)expression_node_81)->finalize, ((struct sNode*)expression_node_81)->_protocol_obj, 0, 0); } 
        if(block_82) { come_call_finalizer(sBlock_finalize,block_82, (void*)0, (void*)0, 0, 0, 0); }
        if(right_value64) { come_call_finalizer(sWhileNode_finalize,right_value64, (void*)0, (void*)0, 0, 1, 0); }
        if(right_value65) { come_call_finalizer(sWhileNode_finalize,right_value65, (void*)0, (void*)0, 0, 1, 0); }
        return __result54__;
    }
    struct sNode* __result55__ = ((struct sNode*)(right_value71=string_node_v8(buf,head,head_sline,info)));
    return __result55__;
}
...
memset(&right_value69, 0, sizeof(void*));
            if(self==(void*)0) {
                struct sWhileNode* __result52__ = (void*)0;
                return __result52__;
            }
            result_83=(struct sWhileNode*)come_increment_ref_count(((struct sWhileNode*)(right_value66=(struct sWhileNode*)come_calloc(1, sizeof(struct sWhileNode)*(1), "09while.c", 83))));
            if(right_value66) { come_call_finalizer(sWhileNode_finalize,right_value66, (void*)0, (void*)0, 0, 1, 0); }
            if(self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
                __dec_obj29=result_83->mExpressionNode;
                result_83->mExpressionNode=(struct sNode*)come_increment_ref_count(((struct sNode*)(right_value67=sNodep_clone(self->mExpressionNode))));
            ...
            if(self!=((void*)0)&&self->mBlock!=((void*)0)) {
                __dec_obj30=result_83->mBlock;
                result_83->mBlock=(struct sBlock*)come_increment_ref_count(((struct sBlock*)(right_value68=sBlock_clone(self->mBlock))));
                if(__dec_obj30) { come_call_finalizer(sBlock_finalize,__dec_obj30, (void*)0, (void*)0, 0, 0, 0); }
                if(right_value68) { come_call_finalizer(sBlock_finalize,right_value68, (void*)0, (void*)0, 0, 1, 0); }
            }
            if(self!=((void*)0)) {
                result_83->sline=self->sline;
            }
            if(self!=((void*)0)&&self->sname!=((void*)0)) {
                __dec_obj31=result_83->sname;
                result_83->sname=(char*)come_increment_ref_count(((char*)(right_value69=string_clone(self->sname))));
            ...
            struct sWhileNode* __result53__ = result_83;
            if(result_83) { come_call_finalizer(sWhileNode_finalize,result_83, (void*)0, (void*)0, 0, 0, 1); }
            return __result53__;
}
