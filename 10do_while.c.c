...
memset(&right_value58, 0, sizeof(void*));
    ...
    struct sDoWhileNode* __result46__ = self;
    if(self) { come_call_finalizer(sDoWhileNode_finalize,self, (void*)0, (void*)0, 0, 0, 1); }
...
memset(&result_0, 0, sizeof(struct sNode*));
        ...
        result_0=(struct sNode*)come_increment_ref_count(((struct sNode*)(right_value1=(struct sNode*)come_calloc(1, sizeof(struct sNode)*(1), "10do_while.c", 20))));
...
memset(&right_value57, 0, sizeof(void*));
        ...
        result_1=(struct sBlock*)come_increment_ref_count(((struct sBlock*)(right_value3=(struct sBlock*)come_calloc(1, sizeof(struct sBlock)*(1), "10do_while.c", 21))));
...
memset(&right_value9, 0, sizeof(void*));
                ...
                result_4=(struct list$1sNodeph*)come_increment_ref_count(((struct list$1sNodeph*)(right_value5=list$1sNodephp_initialize((struct list$1sNodeph*)come_increment_ref_count(((struct list$1sNodeph*)(right_value4=(struct list$1sNodeph*)come_calloc(1, sizeof(struct list$1sNodeph)*(1), "10do_while.c", 26))))))));
...
memset(&litem_8, 0, sizeof(struct list_item$1sNodeph*));
                        if(self->len==0) {
                            litem_6=((struct list_item$1sNodeph*)(right_value6=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "10do_while.c", 32)));
                            litem_6->prev=((void*)0);
                            litem_6->next=((void*)0);
                            ...
                            litem_7=((struct list_item$1sNodeph*)(right_value7=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "10do_while.c", 42)));
                            ...
                            litem_8=((struct list_item$1sNodeph*)(right_value8=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "10do_while.c", 52)));
...
memset(&right_value56, 0, sizeof(void*));
                ...
                result_9=(struct sVarTable*)come_increment_ref_count(((struct sVarTable*)(right_value11=(struct sVarTable*)come_calloc(1, sizeof(struct sVarTable)*(1), "10do_while.c", 25))));
...
memset(&right_value17, 0, sizeof(void*));
                            self->keys=((char**)(right_value13=(char**)come_calloc(1, sizeof(char*)*(1*(1024)), "10do_while.c", 31)));
                            self->items=((struct sVar**)(right_value14=(struct sVar**)come_calloc(1, sizeof(struct sVar*)*(1*(1024)), "10do_while.c", 32)));
                            self->item_existance=((_Bool*)(right_value15=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(1024)), "10do_while.c", 33)));
                            for(
                            i_10=0;
                            i_10<1024;
                            i_10++
                            ...
                            self->key_list=(struct list$1charp*)come_increment_ref_count(((struct list$1charp*)(right_value17=list$1charpp_initialize((struct list$1charp*)come_increment_ref_count(((struct list$1charp*)(right_value16=(struct list$1charp*)come_calloc(1, sizeof(struct list$1charp)*(1), "10do_while.c", 43))))))));
...
memset(&default_value_37, 0, sizeof(struct sVar*)); /* bbb */
                                            ...
                                            keys_28=((char**)(right_value19=(char**)come_calloc(1, sizeof(char*)*(1*(size_27)), "10do_while.c", 41)));
                                            items_29=((struct sVar**)(right_value20=(struct sVar**)come_calloc(1, sizeof(struct sVar*)*(1*(size_27)), "10do_while.c", 42)));
                                            item_existance_30=((_Bool*)(right_value21=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_27)), "10do_while.c", 43)));
                                            len_31=0;
                                            for(
...
memset(&litem_62, 0, sizeof(struct list_item$1charp*));
                                            if(self->len==0) {
                                                litem_60=((struct list_item$1charp*)(right_value22=(struct list_item$1charp*)come_calloc(1, sizeof(struct list_item$1charp)*(1), "10do_while.c", 110)));
                                                ...
                                                litem_61=((struct list_item$1charp*)(right_value23=(struct list_item$1charp*)come_calloc(1, sizeof(struct list_item$1charp)*(1), "10do_while.c", 120)));
                                                ...
                                                litem_62=((struct list_item$1charp*)(right_value24=(struct list_item$1charp*)come_calloc(1, sizeof(struct list_item$1charp)*(1), "10do_while.c", 130)));
...
memset(&right_value53, 0, sizeof(void*));
                                    ...
                                    result_63=(struct sVar*)come_increment_ref_count(((struct sVar*)(right_value27=(struct sVar*)come_calloc(1, sizeof(struct sVar)*(1), "10do_while.c", 42))));
                                    if(self!=((void*)0)&&self->mName!=((void*)0)) {
...
memset(&right_value52, 0, sizeof(void*));
                                            ...
                                            result_64=(struct sType*)come_increment_ref_count(((struct sType*)(right_value30=(struct sType*)come_calloc(1, sizeof(struct sType)*(1), "10do_while.c", 47))));
                                            if(self!=((void*)0)) {
...
memset(&right_value32, 0, sizeof(void*));
                                                    ...
                                                    result_65=(struct tuple1$1sTypeph*)come_increment_ref_count(((struct tuple1$1sTypeph*)(right_value31=(struct tuple1$1sTypeph*)come_calloc(1, sizeof(struct tuple1$1sTypeph)*(1), "10do_while.c", 51))));
                                                    if(self!=((void*)0)&&self->v1!=((void*)0)) {
...
memset(&right_value40, 0, sizeof(void*));
                                                    ...
                                                    result_66=(struct list$1sTypeph*)come_increment_ref_count(((struct list$1sTypeph*)(right_value36=list$1sTypephp_initialize((struct list$1sTypeph*)come_increment_ref_count(((struct list$1sTypeph*)(right_value35=(struct list$1sTypeph*)come_calloc(1, sizeof(struct list$1sTypeph)*(1), "10do_while.c", 55))))))));
...
memset(&litem_70, 0, sizeof(struct list_item$1sTypeph*));
                                                            if(self->len==0) {
                                                                litem_68=((struct list_item$1sTypeph*)(right_value37=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "10do_while.c", 61)));
                                                                ...
                                                                litem_69=((struct list_item$1sTypeph*)(right_value38=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "10do_while.c", 71)));
                                                                ...
                                                                litem_70=((struct list_item$1sTypeph*)(right_value39=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "10do_while.c", 81)));
...
memset(&right_value49, 0, sizeof(void*));
                                                    ...
                                                    result_71=(struct list$1charph*)come_increment_ref_count(((struct list$1charph*)(right_value45=list$1charphp_initialize((struct list$1charph*)come_increment_ref_count(((struct list$1charph*)(right_value44=(struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "10do_while.c", 59))))))));
...
memset(&litem_75, 0, sizeof(struct list_item$1charph*));
                                                            if(self->len==0) {
                                                                litem_73=((struct list_item$1charph*)(right_value46=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "10do_while.c", 65)));
                                                                ...
                                                                litem_74=((struct list_item$1charph*)(right_value47=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "10do_while.c", 75)));
                                                                ...
                                                                litem_75=((struct list_item$1charph*)(right_value48=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "10do_while.c", 85)));
...
memset(&right_value72, 0, sizeof(void*));
    if(charp_operator_equals(buf,"do")) {
        sname_79=(char*)come_increment_ref_count(((char*)(right_value61=string_clone(info->sname))));
        if(right_value61) { right_value61 = come_decrement_ref_count(right_value61, (void*)0, (void*)0, 1, 0); }
        sline_80=info->sline;
        block_81=(struct sBlock*)come_increment_ref_count(((struct sBlock*)(right_value62=parse_block(info,(_Bool)0))));
        if(right_value62) { come_call_finalizer(sBlock_finalize,right_value62, (void*)0, (void*)0, 0, 1, 0); }
        buf2_82=(char*)come_increment_ref_count(((char*)(right_value63=parse_word(info))));
        if(right_value63) { right_value63 = come_decrement_ref_count(right_value63, (void*)0, (void*)0, 1, 0); }
        if(string_operator_not_equals(buf2_82,"while")) {
            err_msg(info,"require while");
            exit(2);
        }
        expected_next_character(40,info);
        expression_node_83=(struct sNode*)come_increment_ref_count(((struct sNode*)(right_value64=expression_v13(info))));
        if(right_value64) { right_value64 = come_decrement_ref_count(right_value64, ((struct sNode*)right_value64)->finalize, ((struct sNode*)right_value64)->_protocol_obj, 1, 0); } 
        expected_next_character(41,info);
        _inf_value1=(struct sNode*)come_calloc(1, sizeof(struct sNode), "10do_while.c", 88);
        _inf_obj_value1=come_increment_ref_count(((struct sDoWhileNode*)(right_value66=sDoWhileNode_initialize((struct sDoWhileNode*)come_increment_ref_count(((struct sDoWhileNode*)(right_value65=(struct sDoWhileNode*)come_calloc(1, sizeof(struct sDoWhileNode)*(1), "10do_while.c", 88)))),(struct sNode*)come_increment_ref_count(expression_node_83),block_81,info))));
        _inf_value1->_protocol_obj=_inf_obj_value1;
        _inf_value1->finalize=sDoWhileNode_finalize;
        _inf_value1->clone=sDoWhileNode_clone;
        _inf_value1->compile=sDoWhileNode_compile;
        _inf_value1->sline=sDoWhileNode_sline;
        _inf_value1->sname=sDoWhileNode_sname;
        _inf_value1->terminated=sDoWhileNode_terminated;
        struct sNode* __result54__ = ((struct sNode*)(right_value71=_inf_value1));
        if(sname_79) { sname_79 = come_decrement_ref_count(sname_79, (void*)0, (void*)0, 0, 0); }
        if(block_81) { come_call_finalizer(sBlock_finalize,block_81, (void*)0, (void*)0, 0, 0, 0); }
        if(buf2_82) { buf2_82 = come_decrement_ref_count(buf2_82, (void*)0, (void*)0, 0, 0); }
        if(expression_node_83) { expression_node_83 = come_decrement_ref_count(expression_node_83, ((struct sNode*)expression_node_83)->finalize, ((struct sNode*)expression_node_83)->_protocol_obj, 0, 0); } 
        if(right_value65) { come_call_finalizer(sDoWhileNode_finalize,right_value65, (void*)0, (void*)0, 0, 1, 0); }
        if(right_value66) { come_call_finalizer(sDoWhileNode_finalize,right_value66, (void*)0, (void*)0, 0, 1, 0); }
        return __result54__;
    }
    struct sNode* __result55__ = ((struct sNode*)(right_value72=string_node_v9(buf,head,head_sline,info)));
    return __result55__;
}
...
memset(&right_value70, 0, sizeof(void*));
            if(self==(void*)0) {
                struct sDoWhileNode* __result52__ = (void*)0;
                return __result52__;
            }
            result_84=(struct sDoWhileNode*)come_increment_ref_count(((struct sDoWhileNode*)(right_value67=(struct sDoWhileNode*)come_calloc(1, sizeof(struct sDoWhileNode)*(1), "10do_while.c", 90))));
            if(right_value67) { come_call_finalizer(sDoWhileNode_finalize,right_value67, (void*)0, (void*)0, 0, 1, 0); }
            if(self!=((void*)0)&&self->mExpressionNode!=((void*)0)) {
                __dec_obj29=result_84->mExpressionNode;
                result_84->mExpressionNode=(struct sNode*)come_increment_ref_count(((struct sNode*)(right_value68=sNodep_clone(self->mExpressionNode))));
            ...
            if(self!=((void*)0)&&self->mBlock!=((void*)0)) {
                __dec_obj30=result_84->mBlock;
                result_84->mBlock=(struct sBlock*)come_increment_ref_count(((struct sBlock*)(right_value69=sBlock_clone(self->mBlock))));
                if(__dec_obj30) { come_call_finalizer(sBlock_finalize,__dec_obj30, (void*)0, (void*)0, 0, 0, 0); }
                if(right_value69) { come_call_finalizer(sBlock_finalize,right_value69, (void*)0, (void*)0, 0, 1, 0); }
            }
            if(self!=((void*)0)) {
                result_84->sline=self->sline;
            }
            if(self!=((void*)0)&&self->sname!=((void*)0)) {
                __dec_obj31=result_84->sname;
                result_84->sname=(char*)come_increment_ref_count(((char*)(right_value70=string_clone(self->sname))));
            ...
            struct sDoWhileNode* __result53__ = result_84;
            if(result_84) { come_call_finalizer(sDoWhileNode_finalize,result_84, (void*)0, (void*)0, 0, 0, 1); }
            return __result53__;
}
