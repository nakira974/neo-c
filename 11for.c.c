...
memset(&result_0, 0, sizeof(struct sNode*));
            ...
            result_0=(struct sNode*)come_increment_ref_count(((struct sNode*)(right_value1=(struct sNode*)come_calloc(1, sizeof(struct sNode)*(1), "11for.c", 23))));
...
memset(&right_value59, 0, sizeof(void*));
        ...
        result_1=(struct sBlock*)come_increment_ref_count(((struct sBlock*)(right_value5=(struct sBlock*)come_calloc(1, sizeof(struct sBlock)*(1), "11for.c", 40))));
...
memset(&right_value11, 0, sizeof(void*));
                ...
                result_4=(struct list$1sNodeph*)come_increment_ref_count(((struct list$1sNodeph*)(right_value7=list$1sNodephp_initialize((struct list$1sNodeph*)come_increment_ref_count(((struct list$1sNodeph*)(right_value6=(struct list$1sNodeph*)come_calloc(1, sizeof(struct list$1sNodeph)*(1), "11for.c", 45))))))));
...
memset(&litem_8, 0, sizeof(struct list_item$1sNodeph*));
                        if(self->len==0) {
                            litem_6=((struct list_item$1sNodeph*)(right_value8=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "11for.c", 51)));
                            litem_6->prev=((void*)0);
                            litem_6->next=((void*)0);
                            ...
                            litem_7=((struct list_item$1sNodeph*)(right_value9=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "11for.c", 61)));
                            ...
                            litem_8=((struct list_item$1sNodeph*)(right_value10=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "11for.c", 71)));
...
memset(&right_value58, 0, sizeof(void*));
                ...
                result_9=(struct sVarTable*)come_increment_ref_count(((struct sVarTable*)(right_value13=(struct sVarTable*)come_calloc(1, sizeof(struct sVarTable)*(1), "11for.c", 44))));
...
memset(&right_value57, 0, sizeof(void*));
                        ...
                        result_19=(struct map$2charphsVarph*)come_increment_ref_count(((struct map$2charphsVarph*)(right_value20=map$2charphsVarphp_initialize((struct map$2charphsVarph*)come_increment_ref_count(((struct map$2charphsVarph*)(right_value14=(struct map$2charphsVarph*)come_calloc(1, sizeof(struct map$2charphsVarph)*(1), "11for.c", 49))))))));
...
memset(&right_value19, 0, sizeof(void*));
                            self->keys=((char**)(right_value15=(char**)come_calloc(1, sizeof(char*)*(1*(1024)), "11for.c", 50)));
                            self->items=((struct sVar**)(right_value16=(struct sVar**)come_calloc(1, sizeof(struct sVar*)*(1*(1024)), "11for.c", 51)));
                            self->item_existance=((_Bool*)(right_value17=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(1024)), "11for.c", 52)));
                            for(
                            i_10=0;
                            i_10<1024;
                            i_10++
                            ...
                            self->key_list=(struct list$1charp*)come_increment_ref_count(((struct list$1charp*)(right_value19=list$1charpp_initialize((struct list$1charp*)come_increment_ref_count(((struct list$1charp*)(right_value18=(struct list$1charp*)come_calloc(1, sizeof(struct list$1charp)*(1), "11for.c", 62))))))));
...
memset(&default_value_37, 0, sizeof(struct sVar*)); /* bbb */
                                            ...
                                            keys_28=((char**)(right_value21=(char**)come_calloc(1, sizeof(char*)*(1*(size_27)), "11for.c", 60)));
                                            items_29=((struct sVar**)(right_value22=(struct sVar**)come_calloc(1, sizeof(struct sVar*)*(1*(size_27)), "11for.c", 61)));
                                            item_existance_30=((_Bool*)(right_value23=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_27)), "11for.c", 62)));
                                            len_31=0;
                                            for(
...
memset(&litem_62, 0, sizeof(struct list_item$1charp*));
                                            if(self->len==0) {
                                                litem_60=((struct list_item$1charp*)(right_value24=(struct list_item$1charp*)come_calloc(1, sizeof(struct list_item$1charp)*(1), "11for.c", 129)));
                                                ...
                                                litem_61=((struct list_item$1charp*)(right_value25=(struct list_item$1charp*)come_calloc(1, sizeof(struct list_item$1charp)*(1), "11for.c", 139)));
                                                ...
                                                litem_62=((struct list_item$1charp*)(right_value26=(struct list_item$1charp*)come_calloc(1, sizeof(struct list_item$1charp)*(1), "11for.c", 149)));
...
memset(&right_value55, 0, sizeof(void*));
                                    ...
                                    result_63=(struct sVar*)come_increment_ref_count(((struct sVar*)(right_value29=(struct sVar*)come_calloc(1, sizeof(struct sVar)*(1), "11for.c", 61))));
                                    if(self!=((void*)0)&&self->mName!=((void*)0)) {
...
memset(&right_value54, 0, sizeof(void*));
                                            ...
                                            result_64=(struct sType*)come_increment_ref_count(((struct sType*)(right_value32=(struct sType*)come_calloc(1, sizeof(struct sType)*(1), "11for.c", 66))));
                                            if(self!=((void*)0)) {
...
memset(&right_value34, 0, sizeof(void*));
                                                    ...
                                                    result_65=(struct tuple1$1sTypeph*)come_increment_ref_count(((struct tuple1$1sTypeph*)(right_value33=(struct tuple1$1sTypeph*)come_calloc(1, sizeof(struct tuple1$1sTypeph)*(1), "11for.c", 70))));
                                                    if(self!=((void*)0)&&self->v1!=((void*)0)) {
...
memset(&right_value42, 0, sizeof(void*));
                                                    ...
                                                    result_66=(struct list$1sTypeph*)come_increment_ref_count(((struct list$1sTypeph*)(right_value38=list$1sTypephp_initialize((struct list$1sTypeph*)come_increment_ref_count(((struct list$1sTypeph*)(right_value37=(struct list$1sTypeph*)come_calloc(1, sizeof(struct list$1sTypeph)*(1), "11for.c", 74))))))));
...
memset(&litem_70, 0, sizeof(struct list_item$1sTypeph*));
                                                            if(self->len==0) {
                                                                litem_68=((struct list_item$1sTypeph*)(right_value39=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "11for.c", 80)));
                                                                ...
                                                                litem_69=((struct list_item$1sTypeph*)(right_value40=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "11for.c", 90)));
                                                                ...
                                                                litem_70=((struct list_item$1sTypeph*)(right_value41=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "11for.c", 100)));
...
memset(&right_value51, 0, sizeof(void*));
                                                    ...
                                                    result_71=(struct list$1charph*)come_increment_ref_count(((struct list$1charph*)(right_value47=list$1charphp_initialize((struct list$1charph*)come_increment_ref_count(((struct list$1charph*)(right_value46=(struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "11for.c", 78))))))));
...
memset(&litem_75, 0, sizeof(struct list_item$1charph*));
                                                            if(self->len==0) {
                                                                litem_73=((struct list_item$1charph*)(right_value48=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "11for.c", 84)));
                                                                ...
                                                                litem_74=((struct list_item$1charph*)(right_value49=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "11for.c", 94)));
                                                                ...
                                                                litem_75=((struct list_item$1charph*)(right_value50=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "11for.c", 104)));
...
memset(&lv_table_77, 0, sizeof(struct sVarTable*));
memset(&right_value61, 0, sizeof(void*));
memset(&right_value62, 0, sizeof(void*));
memset(&for_var_table_78, 0, sizeof(struct sVarTable*));
memset(&expression_node_79, 0, sizeof(struct sNode*));
memset(&conditional_value_80, 0, sizeof(struct CVALUE*));
memset(&right_value63, 0, sizeof(void*));
memset(&expression_node2_81, 0, sizeof(struct sNode*));
memset(&conditional_value2_82, 0, sizeof(struct CVALUE*));
...
memset(&conditional_value3_85, 0, sizeof(struct CVALUE*));
    ...
    for_var_table_78=(struct sVarTable*)come_increment_ref_count(((struct sVarTable*)(right_value62=sVarTable_initialize((struct sVarTable*)come_increment_ref_count(((struct sVarTable*)(right_value61=(struct sVarTable*)come_calloc(1, sizeof(struct sVarTable)*(1), "11for.c", 53)))),(_Bool)0,lv_table_77))));
...
memset(&right_value80, 0, sizeof(void*));
    if(charp_operator_equals(buf,"for")) {
        ...
        _inf_value1=(struct sNode*)come_calloc(1, sizeof(struct sNode), "11for.c", 176);
        _inf_obj_value1=come_increment_ref_count(((struct sForNode*)(right_value72=sForNode_initialize((struct sForNode*)come_increment_ref_count(((struct sForNode*)(right_value71=(struct sForNode*)come_calloc(1, sizeof(struct sForNode)*(1), "11for.c", 176)))),(struct sNode*)come_increment_ref_count(expression_node_86),(struct sNode*)come_increment_ref_count(expression_node2_87),(struct sNode*)come_increment_ref_count(expression_node3_88),block_89,info))));
...
memset(&right_value78, 0, sizeof(void*));
            ...
            result_90=(struct sForNode*)come_increment_ref_count(((struct sForNode*)(right_value73=(struct sForNode*)come_calloc(1, sizeof(struct sForNode)*(1), "11for.c", 178))));
