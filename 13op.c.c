...
memset(&operator_fun_27, 0, sizeof(struct sFun*)); /* ddd */
...
memset(&new_fun_name_47, 0, sizeof(char*)); /* ddd */
memset(&right_value42, 0, sizeof(void*));
memset(&result_48, 0, sizeof(_Bool)); /* ddd */
memset(&right_value43, 0, sizeof(void*));
memset(&come_value_49, 0, sizeof(struct CVALUE*)); /* ddd */
...
memset(&type_55, 0, sizeof(struct sType*)); /* ddd */
...
memset(&right_value53, 0, sizeof(void*));
    ...
    if(operator_fun_27&&(list$1sTypephp_length(type->mGenericsTypes)>0||(string_operator_equals(left_value->type->mClass->mName,right_value->type->mClass->mName)&&left_value->type->mPointerNum==right_value->type->mPointerNum))) {
        come_value_49=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value43=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1)))));
...
memset(&node_285, 0, sizeof(struct sNode*)); /* ddd */
    parse_sharp_v5(info);
...
memset(&right_value469, 0, sizeof(void*));
    if(charp_operator_equals(buf,"null")) {
        ...
        _inf_obj_value25=come_increment_ref_count(((struct sNullNode*)(right_value465=sNullNode_initialize((struct sNullNode*)come_increment_ref_count(((struct sNullNode*)(right_value464=(struct sNullNode*)come_calloc(1, sizeof(struct sNullNode)*(1))))),info))));
...
memset(&right_value67, 0, sizeof(void*));
    ...
    _inf_obj_value1=come_increment_ref_count(((struct sNullNode*)(right_value64=sNullNode_initialize((struct sNullNode*)come_increment_ref_count(((struct sNullNode*)(right_value63=(struct sNullNode*)come_calloc(1, sizeof(struct sNullNode)*(1))))),info))));
...
int i_53;
memset(&it_52, 0, sizeof(struct list_item$1sTypeph*)); /* ddd */
memset(&i_53, 0, sizeof(int)); /* ddd */
                if(position<0) {
                    position+=self->len;
                }
                it_52=self->head;
...
memset(&litem_56, 0, sizeof(struct list_item$1CVALUEph*)); /* ddd */
memset(&right_value55, 0, sizeof(void*));
memset(&litem_57, 0, sizeof(struct list_item$1CVALUEph*)); /* ddd */
memset(&right_value56, 0, sizeof(void*));
memset(&litem_58, 0, sizeof(struct list_item$1CVALUEph*)); /* ddd */
            if(self->len==0) {
                litem_56=((struct list_item$1CVALUEph*)(right_value54=(struct list_item$1CVALUEph*)come_calloc(1, sizeof(struct list_item$1CVALUEph)*(1))));
                ...
                litem_57=((struct list_item$1CVALUEph*)(right_value55=(struct list_item$1CVALUEph*)come_calloc(1, sizeof(struct list_item$1CVALUEph)*(1))));
                ...
                litem_58=((struct list_item$1CVALUEph*)(right_value56=(struct list_item$1CVALUEph*)come_calloc(1, sizeof(struct list_item$1CVALUEph)*(1))));
...
memset(&come_value_59, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&right_value59, 0, sizeof(void*));
memset(&right_value60, 0, sizeof(void*));
memset(&right_value61, 0, sizeof(void*));
    come_value_59=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value58=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1)))));
    ...
    come_value_59->type=(struct sType*)come_increment_ref_count(((struct sType*)(right_value61=sType_initialize((struct sType*)come_increment_ref_count(((struct sType*)(right_value60=(struct sType*)come_calloc(1, sizeof(struct sType)*(1))))),"void*",info,(_Bool)0))));
...
memset(&result_286, 0, sizeof(struct sNullNode*)); /* ddd */
memset(&right_value467, 0, sizeof(void*));
            if(self==(void*)0) {
                struct sNullNode* __result281__ = (void*)0;
                return __result281__;
            }
            result_286=(struct sNullNode*)come_increment_ref_count(((struct sNullNode*)(right_value466=(struct sNullNode*)come_calloc(1, sizeof(struct sNullNode)*(1)))));
...
memset(&left_node_61, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value71, 0, sizeof(void*));
memset(&left_value_62, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&right_node_63, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value72, 0, sizeof(void*));
memset(&right_value_64, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&type_65, 0, sizeof(struct sType*)); /* ddd */
memset(&fun_name_66, 0, sizeof(char*)); /* ddd */
memset(&calling_fun_67, 0, sizeof(_Bool)); /* ddd */
memset(&right_value73, 0, sizeof(void*));
memset(&come_value_68, 0, sizeof(struct CVALUE*)); /* ddd */
...
memset(&right_value75, 0, sizeof(void*));
    ...
    if(!calling_fun_67) {
        come_value_68=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value73=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1)))));
...
memset(&left_node_69, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value80, 0, sizeof(void*));
memset(&left_value_70, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&right_node_71, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value81, 0, sizeof(void*));
memset(&right_value_72, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&type_73, 0, sizeof(struct sType*)); /* ddd */
memset(&fun_name_74, 0, sizeof(char*)); /* ddd */
memset(&calling_fun_75, 0, sizeof(_Bool)); /* ddd */
...
memset(&right_value84, 0, sizeof(void*));
    ...
    if(!calling_fun_75) {
        come_value_76=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value82=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1)))));
...
memset(&left_node_77, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value89, 0, sizeof(void*));
memset(&left_value_78, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&right_node_79, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value90, 0, sizeof(void*));
memset(&right_value_80, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&type_81, 0, sizeof(struct sType*)); /* ddd */
memset(&fun_name_82, 0, sizeof(char*)); /* ddd */
memset(&calling_fun_83, 0, sizeof(_Bool)); /* ddd */
memset(&right_value91, 0, sizeof(void*));
memset(&come_value_84, 0, sizeof(struct CVALUE*)); /* ddd */
...
memset(&right_value93, 0, sizeof(void*));
    ...
    if(!calling_fun_83) {
        come_value_84=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value91=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1)))));
...
memset(&left_node_85, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value98, 0, sizeof(void*));
memset(&left_value_86, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&right_node_87, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value99, 0, sizeof(void*));
memset(&right_value_88, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&type_89, 0, sizeof(struct sType*)); /* ddd */
memset(&fun_name_90, 0, sizeof(char*)); /* ddd */
memset(&calling_fun_91, 0, sizeof(_Bool)); /* ddd */
...
memset(&right_value102, 0, sizeof(void*));
    ...
    if(!calling_fun_91) {
        come_value_92=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value100=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1)))));
...
memset(&left_node_93, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value107, 0, sizeof(void*));
memset(&left_value_94, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&right_node_95, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value108, 0, sizeof(void*));
memset(&right_value_96, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&type_97, 0, sizeof(struct sType*)); /* ddd */
memset(&fun_name_98, 0, sizeof(char*)); /* ddd */
memset(&calling_fun_99, 0, sizeof(_Bool)); /* ddd */
memset(&right_value109, 0, sizeof(void*));
memset(&come_value_100, 0, sizeof(struct CVALUE*)); /* ddd */
...
memset(&right_value111, 0, sizeof(void*));
    ...
    if(!calling_fun_99) {
        come_value_100=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value109=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1)))));
...
memset(&left_node_101, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value116, 0, sizeof(void*));
memset(&left_value_102, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&right_node_103, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value117, 0, sizeof(void*));
memset(&right_value_104, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&type_105, 0, sizeof(struct sType*)); /* ddd */
memset(&fun_name_106, 0, sizeof(char*)); /* ddd */
memset(&calling_fun_107, 0, sizeof(_Bool)); /* ddd */
memset(&right_value118, 0, sizeof(void*));
memset(&come_value_108, 0, sizeof(struct CVALUE*)); /* ddd */
...
memset(&right_value120, 0, sizeof(void*));
    ...
    if(!calling_fun_107) {
        come_value_108=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value118=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1)))));
...
memset(&left_node_109, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value125, 0, sizeof(void*));
memset(&left_value_110, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&right_node_111, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value126, 0, sizeof(void*));
memset(&right_value_112, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&type_113, 0, sizeof(struct sType*)); /* ddd */
memset(&fun_name_114, 0, sizeof(char*)); /* ddd */
memset(&calling_fun_115, 0, sizeof(_Bool)); /* ddd */
memset(&right_value127, 0, sizeof(void*));
memset(&come_value_116, 0, sizeof(struct CVALUE*)); /* ddd */
...
memset(&right_value129, 0, sizeof(void*));
    ...
    if(!calling_fun_115) {
        come_value_116=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value127=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1)))));
...
memset(&left_node_117, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value134, 0, sizeof(void*));
memset(&left_value_118, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&right_node_119, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value135, 0, sizeof(void*));
memset(&right_value_120, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&type_121, 0, sizeof(struct sType*)); /* ddd */
memset(&fun_name_122, 0, sizeof(char*)); /* ddd */
memset(&calling_fun_123, 0, sizeof(_Bool)); /* ddd */
...
memset(&right_value138, 0, sizeof(void*));
    ...
    if(!calling_fun_123) {
        come_value_124=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value136=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1)))));
...
memset(&left_node_125, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value143, 0, sizeof(void*));
memset(&left_value_126, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&right_node_127, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value144, 0, sizeof(void*));
memset(&right_value_128, 0, sizeof(struct CVALUE*)); /* ddd */
...
memset(&right_value147, 0, sizeof(void*));
    ...
    if(!calling_fun_131) {
        come_value_132=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value145=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1)))));
...
memset(&left_node_133, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value152, 0, sizeof(void*));
memset(&left_value_134, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&right_node_135, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value153, 0, sizeof(void*));
memset(&right_value_136, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&type_137, 0, sizeof(struct sType*)); /* ddd */
memset(&fun_name_138, 0, sizeof(char*)); /* ddd */
memset(&calling_fun_139, 0, sizeof(_Bool)); /* ddd */
memset(&right_value154, 0, sizeof(void*));
memset(&come_value_140, 0, sizeof(struct CVALUE*)); /* ddd */
...
memset(&right_value156, 0, sizeof(void*));
    ...
    if(!calling_fun_139) {
        come_value_140=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value154=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1)))));
...
memset(&left_node_141, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value161, 0, sizeof(void*));
memset(&left_value_142, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&right_node_143, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value162, 0, sizeof(void*));
memset(&right_value_144, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&type_145, 0, sizeof(struct sType*)); /* ddd */
memset(&fun_name_146, 0, sizeof(char*)); /* ddd */
memset(&calling_fun_147, 0, sizeof(_Bool)); /* ddd */
memset(&right_value163, 0, sizeof(void*));
memset(&come_value_148, 0, sizeof(struct CVALUE*)); /* ddd */
...
memset(&right_value165, 0, sizeof(void*));
    ...
    if(!calling_fun_147) {
        come_value_148=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value163=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1)))));
...
memset(&left_node_149, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value171, 0, sizeof(void*));
memset(&left_value_150, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&right_node_151, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value172, 0, sizeof(void*));
memset(&right_value_152, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&right_value173, 0, sizeof(void*));
memset(&come_value_153, 0, sizeof(struct CVALUE*)); /* ddd */
...
memset(&right_value175, 0, sizeof(void*));
    ...
    dec_stack_ptr(1,info);
    come_value_153=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value173=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1)))));
...
memset(&left_node_154, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value179, 0, sizeof(void*));
memset(&left_value_155, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&right_node_156, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value180, 0, sizeof(void*));
memset(&right_value_157, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&right_value181, 0, sizeof(void*));
memset(&come_value_158, 0, sizeof(struct CVALUE*)); /* ddd */
...
memset(&right_value183, 0, sizeof(void*));
    ...
    dec_stack_ptr(1,info);
    come_value_158=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value181=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1)))));
...
memset(&left_node_159, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value188, 0, sizeof(void*));
memset(&left_value_160, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&right_node_161, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value189, 0, sizeof(void*));
memset(&right_value_162, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&type_163, 0, sizeof(struct sType*)); /* ddd */
memset(&fun_name_164, 0, sizeof(char*)); /* ddd */
memset(&calling_fun_165, 0, sizeof(_Bool)); /* ddd */
memset(&right_value190, 0, sizeof(void*));
memset(&come_value_166, 0, sizeof(struct CVALUE*)); /* ddd */
...
memset(&right_value192, 0, sizeof(void*));
    ...
    if(!calling_fun_165) {
        come_value_166=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value190=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1)))));
...
memset(&left_node_167, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value197, 0, sizeof(void*));
memset(&left_value_168, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&right_node_169, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value198, 0, sizeof(void*));
memset(&right_value_170, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&type_171, 0, sizeof(struct sType*)); /* ddd */
memset(&fun_name_172, 0, sizeof(char*)); /* ddd */
memset(&calling_fun_173, 0, sizeof(_Bool)); /* ddd */
memset(&right_value199, 0, sizeof(void*));
memset(&come_value_174, 0, sizeof(struct CVALUE*)); /* ddd */
...
memset(&right_value201, 0, sizeof(void*));
    ...
    if(!calling_fun_173) {
        come_value_174=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value199=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1)))));
...
memset(&left_node_175, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value206, 0, sizeof(void*));
memset(&left_value_176, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&right_node_177, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value207, 0, sizeof(void*));
memset(&right_value_178, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&type_179, 0, sizeof(struct sType*)); /* ddd */
memset(&fun_name_180, 0, sizeof(char*)); /* ddd */
memset(&calling_fun_181, 0, sizeof(_Bool)); /* ddd */
...
memset(&right_value210, 0, sizeof(void*));
    ...
    if(!calling_fun_181) {
        come_value_182=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value208=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1)))));
...
memset(&left_node_183, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value215, 0, sizeof(void*));
memset(&left_value_184, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&right_node_185, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value216, 0, sizeof(void*));
memset(&right_value_186, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&type_187, 0, sizeof(struct sType*)); /* ddd */
memset(&fun_name_188, 0, sizeof(char*)); /* ddd */
memset(&calling_fun_189, 0, sizeof(_Bool)); /* ddd */
...
memset(&right_value219, 0, sizeof(void*));
    ...
    if(!calling_fun_189) {
        come_value_190=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value217=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1)))));
...
memset(&left_node_191, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value224, 0, sizeof(void*));
memset(&left_value_192, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&right_node_193, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value225, 0, sizeof(void*));
memset(&right_value_194, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&type_195, 0, sizeof(struct sType*)); /* ddd */
memset(&fun_name_196, 0, sizeof(char*)); /* ddd */
memset(&calling_fun_197, 0, sizeof(_Bool)); /* ddd */
...
memset(&right_value228, 0, sizeof(void*));
    ...
    if(!calling_fun_197) {
        come_value_198=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value226=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1)))));
...
memset(&left_node_199, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value233, 0, sizeof(void*));
memset(&left_value_200, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&right_node_201, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value234, 0, sizeof(void*));
memset(&right_value_202, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&type_203, 0, sizeof(struct sType*)); /* ddd */
memset(&fun_name_204, 0, sizeof(char*)); /* ddd */
memset(&calling_fun_205, 0, sizeof(_Bool)); /* ddd */
...
memset(&right_value237, 0, sizeof(void*));
    ...
    if(!calling_fun_205) {
        come_value_206=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value235=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1)))));
        ...
        if(__dec_obj132) { __dec_obj132 = come_decrement_ref_count(__dec_obj132, (void*)0, (void*)0, 0,0); }
...
memset(&left_node_207, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value242, 0, sizeof(void*));
memset(&left_value_208, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&right_node_209, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value243, 0, sizeof(void*));
memset(&right_value_210, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&type_211, 0, sizeof(struct sType*)); /* ddd */
memset(&fun_name_212, 0, sizeof(char*)); /* ddd */
memset(&calling_fun_213, 0, sizeof(_Bool)); /* ddd */
memset(&right_value244, 0, sizeof(void*));
memset(&come_value_214, 0, sizeof(struct CVALUE*)); /* ddd */
...
memset(&right_value246, 0, sizeof(void*));
    ...
    if(!calling_fun_213) {
        come_value_214=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value244=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1)))));
...
memset(&left_node_215, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value251, 0, sizeof(void*));
memset(&left_value_216, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&right_node_217, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value252, 0, sizeof(void*));
memset(&right_value_218, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&right_value253, 0, sizeof(void*));
memset(&come_value_219, 0, sizeof(struct CVALUE*)); /* ddd */
...
memset(&right_value255, 0, sizeof(void*));
    ...
    dec_stack_ptr(1,info);
    come_value_219=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value253=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1)))));
...
memset(&value1_220, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value261, 0, sizeof(void*));
memset(&value1_value_221, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&value2_222, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value262, 0, sizeof(void*));
memset(&value2_value_223, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&value3_224, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value263, 0, sizeof(void*));
memset(&value3_value_225, 0, sizeof(struct CVALUE*)); /* ddd */
memset(&right_value264, 0, sizeof(void*));
memset(&come_value_226, 0, sizeof(struct CVALUE*)); /* ddd */
...
memset(&right_value266, 0, sizeof(void*));
    ...
    dec_stack_ptr(1,info);
    come_value_226=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value264=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1)))));
    ...
    if(__dec_obj148) { __dec_obj148 = come_decrement_ref_count(__dec_obj148, (void*)0, (void*)0, 0,0); }
...
memset(&node_227, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value269, 0, sizeof(void*));
memset(&right_228, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value270, 0, sizeof(void*));
memset(&right_value271, 0, sizeof(void*));
memset(&right_value276, 0, sizeof(void*));
memset(&right_value277, 0, sizeof(void*));
memset(&right_230, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value278, 0, sizeof(void*));
memset(&right_value279, 0, sizeof(void*));
memset(&right_value284, 0, sizeof(void*));
memset(&right_value285, 0, sizeof(void*));
memset(&right_232, 0, sizeof(struct sNode*)); /* ddd */
...
memset(&right_value292, 0, sizeof(void*));
    ...
    while(*info->p) {
        if(!node_227->terminated(node_227->_protocol_obj)&&*info->p==42&&*(info->p+1)!=61) {
            ...
            _inf_obj_value4=come_increment_ref_count(((struct sModNode*)(right_value287=sModNode_initialize((struct sModNode*)come_increment_ref_count(((struct sModNode*)(right_value286=(struct sModNode*)come_calloc(1, sizeof(struct sModNode)*(1))))),(struct sNode*)come_increment_ref_count(node_227),(struct sNode*)come_increment_ref_count(right_232),info))));
...
memset(&result_229, 0, sizeof(struct sMultNode*)); /* ddd */
...
memset(&right_value275, 0, sizeof(void*));
                ...
                result_229=(struct sMultNode*)come_increment_ref_count(((struct sMultNode*)(right_value272=(struct sMultNode*)come_calloc(1, sizeof(struct sMultNode)*(1)))));
...
memset(&result_231, 0, sizeof(struct sDivNode*)); /* ddd */
...
memset(&right_value283, 0, sizeof(void*));
                ...
                result_231=(struct sDivNode*)come_increment_ref_count(((struct sDivNode*)(right_value280=(struct sDivNode*)come_calloc(1, sizeof(struct sDivNode)*(1)))));
...
memset(&result_233, 0, sizeof(struct sModNode*)); /* ddd */
...
memset(&right_value291, 0, sizeof(void*));
                ...
                result_233=(struct sModNode*)come_increment_ref_count(((struct sModNode*)(right_value288=(struct sModNode*)come_calloc(1, sizeof(struct sModNode)*(1)))));
...
memset(&right_235, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value295, 0, sizeof(void*));
memset(&right_value296, 0, sizeof(void*));
memset(&right_value301, 0, sizeof(void*));
memset(&right_value302, 0, sizeof(void*));
memset(&right_237, 0, sizeof(struct sNode*)); /* ddd */
...
memset(&right_value309, 0, sizeof(void*));
    ...
    while(*info->p) {
        if(*info->p==43&&*(info->p+1)!=61&&*(info->p+1)!=43) {
            ...
            _inf_obj_value5=come_increment_ref_count(((struct sAddNode*)(right_value296=sAddNode_initialize((struct sAddNode*)come_increment_ref_count(((struct sAddNode*)(right_value295=(struct sAddNode*)come_calloc(1, sizeof(struct sAddNode)*(1))))),(struct sNode*)come_increment_ref_count(node_234),(struct sNode*)come_increment_ref_count(right_235),info))));
...
memset(&result_236, 0, sizeof(struct sAddNode*)); /* ddd */
...
memset(&right_value300, 0, sizeof(void*));
                ...
                result_236=(struct sAddNode*)come_increment_ref_count(((struct sAddNode*)(right_value297=(struct sAddNode*)come_calloc(1, sizeof(struct sAddNode)*(1)))));
...
memset(&result_238, 0, sizeof(struct sSubNode*)); /* ddd */
...
memset(&right_value308, 0, sizeof(void*));
                ...
                result_238=(struct sSubNode*)come_increment_ref_count(((struct sSubNode*)(right_value305=(struct sSubNode*)come_calloc(1, sizeof(struct sSubNode)*(1)))));
...
memset(&node_239, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value311, 0, sizeof(void*));
memset(&right_240, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value312, 0, sizeof(void*));
memset(&right_value313, 0, sizeof(void*));
memset(&right_value318, 0, sizeof(void*));
memset(&right_value319, 0, sizeof(void*));
memset(&right_242, 0, sizeof(struct sNode*)); /* ddd */
...
memset(&right_value326, 0, sizeof(void*));
    ...
    while(*info->p) {
        if(*info->p==60&&*(info->p+1)==60&&*(info->p+2)!=61) {
            ...
            _inf_obj_value8=come_increment_ref_count(((struct sRShiftNode*)(right_value321=sRShiftNode_initialize((struct sRShiftNode*)come_increment_ref_count(((struct sRShiftNode*)(right_value320=(struct sRShiftNode*)come_calloc(1, sizeof(struct sRShiftNode)*(1))))),(struct sNode*)come_increment_ref_count(node_239),(struct sNode*)come_increment_ref_count(right_242),info))));
...
memset(&result_241, 0, sizeof(struct sLShiftNode*)); /* ddd */
...
memset(&right_value317, 0, sizeof(void*));
                ...
                result_241=(struct sLShiftNode*)come_increment_ref_count(((struct sLShiftNode*)(right_value314=(struct sLShiftNode*)come_calloc(1, sizeof(struct sLShiftNode)*(1)))));
...
memset(&result_243, 0, sizeof(struct sRShiftNode*)); /* ddd */
...
memset(&right_value325, 0, sizeof(void*));
                ...
                result_243=(struct sRShiftNode*)come_increment_ref_count(((struct sRShiftNode*)(right_value322=(struct sRShiftNode*)come_calloc(1, sizeof(struct sRShiftNode)*(1)))));
...
memset(&right_245, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value329, 0, sizeof(void*));
memset(&right_value330, 0, sizeof(void*));
memset(&right_value335, 0, sizeof(void*));
memset(&right_value336, 0, sizeof(void*));
memset(&right_247, 0, sizeof(struct sNode*)); /* ddd */
...
memset(&right_249, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value345, 0, sizeof(void*));
memset(&right_value346, 0, sizeof(void*));
memset(&right_value351, 0, sizeof(void*));
memset(&right_value352, 0, sizeof(void*));
memset(&right_251, 0, sizeof(struct sNode*)); /* ddd */
...
memset(&right_value359, 0, sizeof(void*));
    ...
    while(*info->p) {
        if(*info->p==62&&*(info->p+1)==61) {
            ...
            _inf_obj_value9=come_increment_ref_count(((struct sGtEqNode*)(right_value330=sGtEqNode_initialize((struct sGtEqNode*)come_increment_ref_count(((struct sGtEqNode*)(right_value329=(struct sGtEqNode*)come_calloc(1, sizeof(struct sGtEqNode)*(1))))),(struct sNode*)come_increment_ref_count(node_244),(struct sNode*)come_increment_ref_count(right_245),info))));
            ...
            _inf_obj_value12=come_increment_ref_count(((struct sLtNode*)(right_value354=sLtNode_initialize((struct sLtNode*)come_increment_ref_count(((struct sLtNode*)(right_value353=(struct sLtNode*)come_calloc(1, sizeof(struct sLtNode)*(1))))),(struct sNode*)come_increment_ref_count(node_244),(struct sNode*)come_increment_ref_count(right_251),info))));
...
memset(&result_246, 0, sizeof(struct sGtEqNode*)); /* ddd */
...
memset(&right_value334, 0, sizeof(void*));
                ...
                result_246=(struct sGtEqNode*)come_increment_ref_count(((struct sGtEqNode*)(right_value331=(struct sGtEqNode*)come_calloc(1, sizeof(struct sGtEqNode)*(1)))));
...
memset(&result_248, 0, sizeof(struct sLtEqNode*)); /* ddd */
...
memset(&right_value342, 0, sizeof(void*));
                ...
                result_248=(struct sLtEqNode*)come_increment_ref_count(((struct sLtEqNode*)(right_value339=(struct sLtEqNode*)come_calloc(1, sizeof(struct sLtEqNode)*(1)))));
...
memset(&result_250, 0, sizeof(struct sGtNode*)); /* ddd */
...
memset(&right_value350, 0, sizeof(void*));
                ...
                result_250=(struct sGtNode*)come_increment_ref_count(((struct sGtNode*)(right_value347=(struct sGtNode*)come_calloc(1, sizeof(struct sGtNode)*(1)))));
...
memset(&result_252, 0, sizeof(struct sLtNode*)); /* ddd */
...
memset(&right_value358, 0, sizeof(void*));
                ...
                result_252=(struct sLtNode*)come_increment_ref_count(((struct sLtNode*)(right_value355=(struct sLtNode*)come_calloc(1, sizeof(struct sLtNode)*(1)))));
...
memset(&node_253, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value361, 0, sizeof(void*));
memset(&right_254, 0, sizeof(struct sNode*)); /* ddd */
...
memset(&right_256, 0, sizeof(struct sNode*)); /* ddd */
...
memset(&right_258, 0, sizeof(struct sNode*)); /* ddd */
...
memset(&right_260, 0, sizeof(struct sNode*)); /* ddd */
...
memset(&right_value392, 0, sizeof(void*));
    ...
    while(*info->p) {
        if(*info->p==61&&*(info->p+1)==61&&*(info->p+2)==61) {
            ...
            _inf_obj_value13=come_increment_ref_count(((struct sEq2Node*)(right_value363=sEq2Node_initialize((struct sEq2Node*)come_increment_ref_count(((struct sEq2Node*)(right_value362=(struct sEq2Node*)come_calloc(1, sizeof(struct sEq2Node)*(1))))),(struct sNode*)come_increment_ref_count(node_253),(struct sNode*)come_increment_ref_count(right_254),info))));
            ...
            _inf_obj_value14=come_increment_ref_count(((struct sEqNode*)(right_value371=sEqNode_initialize((struct sEqNode*)come_increment_ref_count(((struct sEqNode*)(right_value370=(struct sEqNode*)come_calloc(1, sizeof(struct sEqNode)*(1))))),(struct sNode*)come_increment_ref_count(node_253),(struct sNode*)come_increment_ref_count(right_256),info))));
            ...
            _inf_obj_value15=come_increment_ref_count(((struct sNotEq2Node*)(right_value379=sNotEq2Node_initialize((struct sNotEq2Node*)come_increment_ref_count(((struct sNotEq2Node*)(right_value378=(struct sNotEq2Node*)come_calloc(1, sizeof(struct sNotEq2Node)*(1))))),(struct sNode*)come_increment_ref_count(node_253),(struct sNode*)come_increment_ref_count(right_258),info))));
...
memset(&result_255, 0, sizeof(struct sEq2Node*)); /* ddd */
...
memset(&right_value367, 0, sizeof(void*));
                ...
                result_255=(struct sEq2Node*)come_increment_ref_count(((struct sEq2Node*)(right_value364=(struct sEq2Node*)come_calloc(1, sizeof(struct sEq2Node)*(1)))));
...
memset(&result_257, 0, sizeof(struct sEqNode*)); /* ddd */
...
memset(&right_value375, 0, sizeof(void*));
                ...
                result_257=(struct sEqNode*)come_increment_ref_count(((struct sEqNode*)(right_value372=(struct sEqNode*)come_calloc(1, sizeof(struct sEqNode)*(1)))));
...
memset(&result_259, 0, sizeof(struct sNotEq2Node*)); /* ddd */
...
memset(&right_value383, 0, sizeof(void*));
                ...
                result_259=(struct sNotEq2Node*)come_increment_ref_count(((struct sNotEq2Node*)(right_value380=(struct sNotEq2Node*)come_calloc(1, sizeof(struct sNotEq2Node)*(1)))));
...
memset(&result_261, 0, sizeof(struct sNotEqNode*)); /* ddd */
...
memset(&right_value391, 0, sizeof(void*));
                ...
                result_261=(struct sNotEqNode*)come_increment_ref_count(((struct sNotEqNode*)(right_value388=(struct sNotEqNode*)come_calloc(1, sizeof(struct sNotEqNode)*(1)))));
...
memset(&node_262, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value394, 0, sizeof(void*));
memset(&right_263, 0, sizeof(struct sNode*)); /* ddd */
...
memset(&result_264, 0, sizeof(struct sAndNode*)); /* ddd */
...
memset(&right_value400, 0, sizeof(void*));
                ...
                result_264=(struct sAndNode*)come_increment_ref_count(((struct sAndNode*)(right_value397=(struct sAndNode*)come_calloc(1, sizeof(struct sAndNode)*(1)))));
...
memset(&node_265, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value403, 0, sizeof(void*));
memset(&right_266, 0, sizeof(struct sNode*)); /* ddd */
...
memset(&result_267, 0, sizeof(struct sXOrNode*)); /* ddd */
...
memset(&right_value409, 0, sizeof(void*));
                ...
                result_267=(struct sXOrNode*)come_increment_ref_count(((struct sXOrNode*)(right_value406=(struct sXOrNode*)come_calloc(1, sizeof(struct sXOrNode)*(1)))));
...
memset(&node_268, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value412, 0, sizeof(void*));
memset(&right_269, 0, sizeof(struct sNode*)); /* ddd */
...
memset(&result_270, 0, sizeof(struct sOrNode*)); /* ddd */
...
memset(&right_value418, 0, sizeof(void*));
                ...
                result_270=(struct sOrNode*)come_increment_ref_count(((struct sOrNode*)(right_value415=(struct sOrNode*)come_calloc(1, sizeof(struct sOrNode)*(1)))));
...
memset(&right_272, 0, sizeof(struct sNode*)); /* ddd */
...
memset(&right_value428, 0, sizeof(void*));
    ...
    while(*info->p) {
        if(*info->p==38&&*(info->p+1)==38) {
            ...
            _inf_obj_value20=come_increment_ref_count(((struct sAndAndNode*)(right_value423=sAndAndNode_initialize((struct sAndAndNode*)come_increment_ref_count(((struct sAndAndNode*)(right_value422=(struct sAndAndNode*)come_calloc(1, sizeof(struct sAndAndNode)*(1))))),(struct sNode*)come_increment_ref_count(node_271),(struct sNode*)come_increment_ref_count(right_272),info))));
...
memset(&result_273, 0, sizeof(struct sAndAndNode*)); /* ddd */
...
memset(&right_value427, 0, sizeof(void*));
                ...
                result_273=(struct sAndAndNode*)come_increment_ref_count(((struct sAndAndNode*)(right_value424=(struct sAndAndNode*)come_calloc(1, sizeof(struct sAndAndNode)*(1)))));
...
memset(&node_274, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value430, 0, sizeof(void*));
memset(&right_275, 0, sizeof(struct sNode*)); /* ddd */
...
memset(&right_value437, 0, sizeof(void*));
    ...
    while(*info->p) {
        if(*info->p==124&&*(info->p+1)==124) {
            ...
            _inf_obj_value21=come_increment_ref_count(((struct sOrOrNode*)(right_value432=sOrOrNode_initialize((struct sOrOrNode*)come_increment_ref_count(((struct sOrOrNode*)(right_value431=(struct sOrOrNode*)come_calloc(1, sizeof(struct sOrOrNode)*(1))))),(struct sNode*)come_increment_ref_count(node_274),(struct sNode*)come_increment_ref_count(right_275),info))));
...
memset(&result_276, 0, sizeof(struct sOrOrNode*)); /* ddd */
...
memset(&right_value436, 0, sizeof(void*));
                ...
                result_276=(struct sOrOrNode*)come_increment_ref_count(((struct sOrOrNode*)(right_value433=(struct sOrOrNode*)come_calloc(1, sizeof(struct sOrOrNode)*(1)))));
...
memset(&node_277, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value439, 0, sizeof(void*));
memset(&node2_278, 0, sizeof(struct sNode*)); /* ddd */
...
memset(&right_value446, 0, sizeof(void*));
    ...
    while(*info->p) {
        if(!info->no_comma&&*info->p==44) {
            ...
            _inf_obj_value22=come_increment_ref_count(((struct sCommaNode*)(right_value441=sCommaNode_initialize((struct sCommaNode*)come_increment_ref_count(((struct sCommaNode*)(right_value440=(struct sCommaNode*)come_calloc(1, sizeof(struct sCommaNode)*(1))))),(struct sNode*)come_increment_ref_count(node_277),(struct sNode*)come_increment_ref_count(node2_278),info))));
...
memset(&result_279, 0, sizeof(struct sCommaNode*)); /* ddd */
...
memset(&right_value445, 0, sizeof(void*));
                ...
                result_279=(struct sCommaNode*)come_increment_ref_count(((struct sCommaNode*)(right_value442=(struct sCommaNode*)come_calloc(1, sizeof(struct sCommaNode)*(1)))));
...
memset(&value2_283, 0, sizeof(struct sNode*)); /* ddd */
    ...
    while(*info->p) {
        if(*info->p==63) {
            ...
            if(*info->p==58) {
                ...
                _inf_obj_value23=come_increment_ref_count(((struct sNullNode*)(right_value449=sNullNode_initialize((struct sNullNode*)come_increment_ref_count(((struct sNullNode*)(right_value448=(struct sNullNode*)come_calloc(1, sizeof(struct sNullNode)*(1))))),info))));
...
memset(&result_284, 0, sizeof(struct sConditionalNode*)); /* ddd */
...
memset(&right_value461, 0, sizeof(void*));
                ...
                result_284=(struct sConditionalNode*)come_increment_ref_count(((struct sConditionalNode*)(right_value457=(struct sConditionalNode*)come_calloc(1, sizeof(struct sConditionalNode)*(1)))));
