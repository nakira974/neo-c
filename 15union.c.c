...
memset(&right_value30, 0, sizeof(void*));
        ...
        result_0=(struct sType*)come_increment_ref_count(((struct sType*)(right_value1=(struct sType*)come_calloc(1, sizeof(struct sType)*(1), "15union.c", 18))));
...
memset(&right_value3, 0, sizeof(void*));
                ...
                result_7=(struct tuple1$1sTypeph*)come_increment_ref_count(((struct tuple1$1sTypeph*)(right_value2=(struct tuple1$1sTypeph*)come_calloc(1, sizeof(struct tuple1$1sTypeph)*(1), "15union.c", 22))));
...
memset(&right_value11, 0, sizeof(void*));
                ...
                result_8=(struct list$1sTypeph*)come_increment_ref_count(((struct list$1sTypeph*)(right_value7=list$1sTypephp_initialize((struct list$1sTypeph*)come_increment_ref_count(((struct list$1sTypeph*)(right_value6=(struct list$1sTypeph*)come_calloc(1, sizeof(struct list$1sTypeph)*(1), "15union.c", 26))))))));
...
memset(&litem_12, 0, sizeof(struct list_item$1sTypeph*));
                        if(self->len==0) {
                            litem_10=((struct list_item$1sTypeph*)(right_value8=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "15union.c", 32)));
                            ...
                            litem_11=((struct list_item$1sTypeph*)(right_value9=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "15union.c", 42)));
                            ...
                            litem_12=((struct list_item$1sTypeph*)(right_value10=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "15union.c", 52)));
...
memset(&right_value19, 0, sizeof(void*));
                ...
                result_13=(struct list$1sNodeph*)come_increment_ref_count(((struct list$1sNodeph*)(right_value14=list$1sNodephp_initialize((struct list$1sNodeph*)come_increment_ref_count(((struct list$1sNodeph*)(right_value13=(struct list$1sNodeph*)come_calloc(1, sizeof(struct list$1sNodeph)*(1), "15union.c", 27))))))));
...
memset(&litem_17, 0, sizeof(struct list_item$1sNodeph*));
                        if(self->len==0) {
                            litem_15=((struct list_item$1sNodeph*)(right_value15=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "15union.c", 33)));
                            ...
                            litem_16=((struct list_item$1sNodeph*)(right_value16=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "15union.c", 43)));
                            ...
                            litem_17=((struct list_item$1sNodeph*)(right_value17=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "15union.c", 53)));
...
memset(&result_18, 0, sizeof(struct sNode*));
                        ...
                        result_18=(struct sNode*)come_increment_ref_count(((struct sNode*)(right_value18=(struct sNode*)come_calloc(1, sizeof(struct sNode)*(1), "15union.c", 33))));
...
memset(&right_value27, 0, sizeof(void*));
                ...
                result_19=(struct list$1charph*)come_increment_ref_count(((struct list$1charph*)(right_value23=list$1charphp_initialize((struct list$1charph*)come_increment_ref_count(((struct list$1charph*)(right_value22=(struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "15union.c", 30))))))));
...
memset(&litem_23, 0, sizeof(struct list_item$1charph*));
                        if(self->len==0) {
                            litem_21=((struct list_item$1charph*)(right_value24=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "15union.c", 36)));
                            ...
                            litem_22=((struct list_item$1charph*)(right_value25=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "15union.c", 46)));
                            ...
                            litem_23=((struct list_item$1charph*)(right_value26=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "15union.c", 56)));
...
char* it2_59;
memset(&hash_39, 0, sizeof(int));
memset(&it_40, 0, sizeof(int));
memset(&same_key_exist_57, 0, sizeof(_Bool));
memset(&it2_59, 0, sizeof(char*));
...
memset(&it2_35, 0, sizeof(struct sType*));
memset(&hash_36, 0, sizeof(int));
memset(&n_37, 0, sizeof(int));
memset(&default_value_38, 0, sizeof(struct sType*)); /* bbb */
                size_24=self->size*10;
                keys_25=((char**)(right_value32=(char**)come_calloc(1, sizeof(char*)*(1*(size_24)), "15union.c", 22)));
                items_26=((struct sType**)(right_value33=(struct sType**)come_calloc(1, sizeof(struct sType*)*(1*(size_24)), "15union.c", 23)));
                item_existance_27=((_Bool*)(right_value34=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_24)), "15union.c", 24)));
                len_28=0;
                for(
...
memset(&it2_41, 0, sizeof(int));
memset(&it_42, 0, sizeof(struct list_item$1charp*));
                            it2_41=0;
                            it_42=self->head;
                            while(it_42!=((void*)0)) {
...
memset(&head_prev_it_53, 0, sizeof(struct list_item$1charp*));
memset(&tail_it_54, 0, sizeof(struct list_item$1charp*));
...
memset(&prev_it_45, 0, sizeof(struct list_item$1charp*));
                                                it_44=self->head;
                                                while(it_44!=((void*)0)) {
                                                    prev_it_45=it_44;
                                                    it_44=it_44->next;
...
memset(&litem_63, 0, sizeof(struct list_item$1charp*));
                if(self->len==0) {
                    litem_61=((struct list_item$1charp*)(right_value35=(struct list_item$1charp*)come_calloc(1, sizeof(struct list_item$1charp)*(1), "15union.c", 91)));
                    ...
                    litem_62=((struct list_item$1charp*)(right_value36=(struct list_item$1charp*)come_calloc(1, sizeof(struct list_item$1charp)*(1), "15union.c", 101)));
                    ...
                    litem_63=((struct list_item$1charp*)(right_value37=(struct list_item$1charp*)come_calloc(1, sizeof(struct list_item$1charp)*(1), "15union.c", 111)));
...
memset(&klass_65, 0, sizeof(struct sClass*));
...
memset(&right_value45, 0, sizeof(void*));
    ...
    if(!klass_65->mOutputed) {
        ...
        buf_66=(struct buffer*)come_increment_ref_count(((struct buffer*)(right_value41=buffer_initialize((struct buffer*)come_increment_ref_count(((struct buffer*)(right_value40=(struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "15union.c", 36))))))));
...
memset(&right_value65, 0, sizeof(void*));
    ...
    type_93=(struct sType*)come_increment_ref_count(((struct sType*)(right_value53=sType_initialize((struct sType*)come_increment_ref_count(((struct sType*)(right_value52=(struct sType*)come_calloc(1, sizeof(struct sType)*(1), "15union.c", 70)))),type_name,info,(_Bool)0))));
    ...
    _inf_value1=(struct sNode*)come_calloc(1, sizeof(struct sNode), "15union.c", 94);
    _inf_obj_value1=come_increment_ref_count(((struct sUnionNode*)(right_value61=sUnionNode_initialize((struct sUnionNode*)come_increment_ref_count(((struct sUnionNode*)(right_value60=(struct sUnionNode*)come_calloc(1, sizeof(struct sUnionNode)*(1), "15union.c", 94)))),(struct sType*)come_increment_ref_count(type_93),info))));
...
memset(&default_value_86, 0, sizeof(struct sClass*)); /* bbb */
                ...
                keys_73=((char**)(right_value47=(char**)come_calloc(1, sizeof(char*)*(1*(size_72)), "15union.c", 72)));
                items_74=((struct sClass**)(right_value48=(struct sClass**)come_calloc(1, sizeof(struct sClass*)*(1*(size_72)), "15union.c", 73)));
                item_existance_75=((_Bool*)(right_value49=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_72)), "15union.c", 74)));
                len_76=0;
                for(
...
memset(&it_94, 0, sizeof(struct list_item$1tuple2$2charphsTypephph*));
memset(&prev_it_95, 0, sizeof(struct list_item$1tuple2$2charphsTypephph*));
        it_94=self->head;
        while(it_94!=((void*)0)) {
            prev_it_95=it_94;
            it_94=it_94->next;
...
memset(&litem_101, 0, sizeof(struct list_item$1tuple2$2charphsTypephph*));
            if(self->len==0) {
                litem_99=((struct list_item$1tuple2$2charphsTypephph*)(right_value55=(struct list_item$1tuple2$2charphsTypephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsTypephph)*(1), "15union.c", 87)));
                ...
                litem_100=((struct list_item$1tuple2$2charphsTypephph*)(right_value56=(struct list_item$1tuple2$2charphsTypephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsTypephph)*(1), "15union.c", 97)));
                ...
                litem_101=((struct list_item$1tuple2$2charphsTypephph*)(right_value57=(struct list_item$1tuple2$2charphsTypephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsTypephph)*(1), "15union.c", 107)));
...
memset(&right_value81, 0, sizeof(void*));
    if(string_operator_equals(buf,"union")) {
        ...
        type_104=(struct sType*)come_increment_ref_count(((struct sType*)(right_value70=sType_initialize((struct sType*)come_increment_ref_count(((struct sType*)(right_value69=(struct sType*)come_calloc(1, sizeof(struct sType)*(1), "15union.c", 104)))),type_name_103,info,(_Bool)0))));
        ...
        while((_Bool)1) {
            ...
            expected_next_character(59,info);
            list$1tuple2$2charphsTypephphp_push_back(type_104->mClass->mFields,(struct tuple2$2charphsTypeph*)come_increment_ref_count(((struct tuple2$2charphsTypeph*)(right_value73=tuple2$2charphsTypephp_initialize((struct tuple2$2charphsTypeph*)come_increment_ref_count(((struct tuple2$2charphsTypeph*)(right_value72=(struct tuple2$2charphsTypeph*)come_calloc(1, sizeof(struct tuple2$2charphsTypeph)*(1), "15union.c", 118)))),(char*)come_increment_ref_count(name_106),(struct sType*)come_increment_ref_count(type2_105))))));
        ...
        _inf_value2=(struct sNode*)come_calloc(1, sizeof(struct sNode), "15union.c", 127);
        _inf_obj_value2=come_increment_ref_count(((struct sUnionNode*)(right_value75=sUnionNode_initialize((struct sUnionNode*)come_increment_ref_count(((struct sUnionNode*)(right_value74=(struct sUnionNode*)come_calloc(1, sizeof(struct sUnionNode)*(1), "15union.c", 127)))),(struct sType*)come_increment_ref_count(type_104),info))));
...
memset(&result_108, 0, sizeof(struct sUnionNode*));
...
memset(&right_value78, 0, sizeof(void*));
            ...
            result_108=(struct sUnionNode*)come_increment_ref_count(((struct sUnionNode*)(right_value76=(struct sUnionNode*)come_calloc(1, sizeof(struct sUnionNode)*(1), "15union.c", 129))));
