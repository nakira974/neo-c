...
memset(&right_value22, 0, sizeof(void*));
    ...
    it_14=list$1tuple2$2charphsNodephphp_next((elements_10))
        ...
        if(value_17==((void*)0)) {
            ...
            add_variable_to_global_table_with_int_value(name_16,((struct sType*)(right_value19=sType_initialize((struct sType*)come_increment_ref_count(((struct sType*)(right_value18=(struct sType*)come_calloc(1, sizeof(struct sType)*(1))))),"int",info,(_Bool)0))),right_value_18->c_value,info);
