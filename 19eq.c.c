...
memset(&result_0, 0, sizeof(struct sNode*));
        ...
        result_0=(struct sNode*)come_increment_ref_count(((struct sNode*)(right_value1=(struct sNode*)come_calloc(1, sizeof(struct sNode)*(1), "19eq.c", 18))));
...
memset(&right_value35, 0, sizeof(void*));
    ...
    come_value_9=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value4=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "19eq.c", 37))));
...
memset(&right_value34, 0, sizeof(void*));
        ...
        result_10=(struct sType*)come_increment_ref_count(((struct sType*)(right_value6=(struct sType*)come_calloc(1, sizeof(struct sType)*(1), "19eq.c", 42))));
        ...
        if(self!=((void*)0)) {
            result_10->mComeMemCore=self->mComeMemCore;
        }
        if(self!=((void*)0)) {
...
memset(&right_value8, 0, sizeof(void*));
                ...
                result_11=(struct tuple1$1sTypeph*)come_increment_ref_count(((struct tuple1$1sTypeph*)(right_value7=(struct tuple1$1sTypeph*)come_calloc(1, sizeof(struct tuple1$1sTypeph)*(1), "19eq.c", 46))));
...
memset(&right_value16, 0, sizeof(void*));
                ...
                result_12=(struct list$1sTypeph*)come_increment_ref_count(((struct list$1sTypeph*)(right_value12=list$1sTypephp_initialize((struct list$1sTypeph*)come_increment_ref_count(((struct list$1sTypeph*)(right_value11=(struct list$1sTypeph*)come_calloc(1, sizeof(struct list$1sTypeph)*(1), "19eq.c", 50))))))));
...
memset(&litem_16, 0, sizeof(struct list_item$1sTypeph*));
                        if(self->len==0) {
                            litem_14=((struct list_item$1sTypeph*)(right_value13=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "19eq.c", 56)));
                            ...
                            litem_15=((struct list_item$1sTypeph*)(right_value14=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "19eq.c", 66)));
                            ...
                            litem_16=((struct list_item$1sTypeph*)(right_value15=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "19eq.c", 76)));
...
memset(&right_value23, 0, sizeof(void*));
                ...
                result_17=(struct list$1sNodeph*)come_increment_ref_count(((struct list$1sNodeph*)(right_value19=list$1sNodephp_initialize((struct list$1sNodeph*)come_increment_ref_count(((struct list$1sNodeph*)(right_value18=(struct list$1sNodeph*)come_calloc(1, sizeof(struct list$1sNodeph)*(1), "19eq.c", 51))))))));
...
memset(&litem_21, 0, sizeof(struct list_item$1sNodeph*));
                        if(self->len==0) {
                            litem_19=((struct list_item$1sNodeph*)(right_value20=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "19eq.c", 57)));
                            ...
                            litem_20=((struct list_item$1sNodeph*)(right_value21=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "19eq.c", 67)));
                            ...
                            litem_21=((struct list_item$1sNodeph*)(right_value22=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "19eq.c", 77)));
...
memset(&right_value31, 0, sizeof(void*));
                ...
                result_22=(struct list$1charph*)come_increment_ref_count(((struct list$1charph*)(right_value27=list$1charphp_initialize((struct list$1charph*)come_increment_ref_count(((struct list$1charph*)(right_value26=(struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "19eq.c", 54))))))));
...
memset(&litem_26, 0, sizeof(struct list_item$1charph*));
                        if(self->len==0) {
                            litem_24=((struct list_item$1charph*)(right_value28=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "19eq.c", 60)));
                            ...
                            litem_25=((struct list_item$1charph*)(right_value29=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "19eq.c", 70)));
                            ...
                            litem_26=((struct list_item$1charph*)(right_value30=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "19eq.c", 80)));
...
memset(&litem_29, 0, sizeof(struct list_item$1CVALUEph*));
        if(self->len==0) {
            litem_27=((struct list_item$1CVALUEph*)(right_value36=(struct list_item$1CVALUEph*)come_calloc(1, sizeof(struct list_item$1CVALUEph)*(1), "19eq.c", 45)));
            ...
            litem_28=((struct list_item$1CVALUEph*)(right_value37=(struct list_item$1CVALUEph*)come_calloc(1, sizeof(struct list_item$1CVALUEph)*(1), "19eq.c", 55)));
            ...
            litem_29=((struct list_item$1CVALUEph*)(right_value38=(struct list_item$1CVALUEph*)come_calloc(1, sizeof(struct list_item$1CVALUEph)*(1), "19eq.c", 65)));
...
memset(&right_value45, 0, sizeof(void*));
    ...
    dec_stack_ptr(1,info);
    come_value_32=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value43=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "19eq.c", 94))));
...
memset(&right_value54, 0, sizeof(void*));
    ...
    dec_stack_ptr(1,info);
    come_value_37=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value52=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "19eq.c", 162))));
...
memset(&right_value63, 0, sizeof(void*));
    ...
    dec_stack_ptr(1,info);
    come_value_42=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value61=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "19eq.c", 230))));
...
memset(&right_value72, 0, sizeof(void*));
    ...
    dec_stack_ptr(1,info);
    come_value_47=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value70=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "19eq.c", 298))));
...
memset(&right_value81, 0, sizeof(void*));
    ...
    dec_stack_ptr(1,info);
    come_value_52=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value79=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "19eq.c", 366))));
...
memset(&right_value90, 0, sizeof(void*));
    ...
    dec_stack_ptr(1,info);
    come_value_57=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value88=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "19eq.c", 434))));
...
memset(&right_value99, 0, sizeof(void*));
    ...
    dec_stack_ptr(1,info);
    come_value_62=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value97=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "19eq.c", 503))));
...
memset(&right_value108, 0, sizeof(void*));
    ...
    dec_stack_ptr(1,info);
    come_value_67=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value106=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "19eq.c", 571))));
...
memset(&right_value117, 0, sizeof(void*));
    ...
    dec_stack_ptr(1,info);
    come_value_72=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value115=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "19eq.c", 639))));
...
memset(&right_value126, 0, sizeof(void*));
    ...
    dec_stack_ptr(1,info);
    come_value_77=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value124=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "19eq.c", 707))));
...
memset(&right_value135, 0, sizeof(void*));
    ...
    dec_stack_ptr(1,info);
    come_value_82=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value133=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "19eq.c", 775))));
...
memset(&right_value144, 0, sizeof(void*));
    ...
    dec_stack_ptr(1,info);
    come_value_87=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value142=(struct CVALUE*)come_calloc(1, sizeof(struct CVALUE)*(1), "19eq.c", 843))));
...
memset(&right_value245, 0, sizeof(void*));
    if(*info->p==43&&*(info->p+1)==43) {
        ...
        _inf_value1=(struct sNode*)come_calloc(1, sizeof(struct sNode), "19eq.c", 872);
        _inf_obj_value1=come_increment_ref_count(((struct sPlusPlusNode*)(right_value147=sPlusPlusNode_initialize((struct sPlusPlusNode*)come_increment_ref_count(((struct sPlusPlusNode*)(right_value146=(struct sPlusPlusNode*)come_calloc(1, sizeof(struct sPlusPlusNode)*(1), "19eq.c", 872)))),(struct sNode*)come_increment_ref_count(node),info))));
        ...
        info->p+=2;
        skip_spaces_and_lf(info);
        _inf_value2=(struct sNode*)come_calloc(1, sizeof(struct sNode), "19eq.c", 878);
        _inf_obj_value2=come_increment_ref_count(((struct sMinusMinusNode*)(right_value153=sMinusMinusNode_initialize((struct sMinusMinusNode*)come_increment_ref_count(((struct sMinusMinusNode*)(right_value152=(struct sMinusMinusNode*)come_calloc(1, sizeof(struct sMinusMinusNode)*(1), "19eq.c", 878)))),(struct sNode*)come_increment_ref_count(node),info))));
        ...
        _inf_value6=(struct sNode*)come_calloc(1, sizeof(struct sNode), "19eq.c", 910);
        _inf_obj_value6=come_increment_ref_count(((struct sDivEqualNode*)(right_value184=sDivEqualNode_initialize((struct sDivEqualNode*)come_increment_ref_count(((struct sDivEqualNode*)(right_value183=(struct sDivEqualNode*)come_calloc(1, sizeof(struct sDivEqualNode)*(1), "19eq.c", 910)))),(struct sNode*)come_increment_ref_count(node),(struct sNode*)come_increment_ref_count(right_node_96),info))));
        ...
        _inf_value7=(struct sNode*)come_calloc(1, sizeof(struct sNode), "19eq.c", 918);
        _inf_obj_value7=come_increment_ref_count(((struct sModEqualNode*)(right_value192=sModEqualNode_initialize((struct sModEqualNode*)come_increment_ref_count(((struct sModEqualNode*)(right_value191=(struct sModEqualNode*)come_calloc(1, sizeof(struct sModEqualNode)*(1), "19eq.c", 918)))),(struct sNode*)come_increment_ref_count(node),(struct sNode*)come_increment_ref_count(right_node_98),info))));
        ...
        _inf_value8=(struct sNode*)come_calloc(1, sizeof(struct sNode), "19eq.c", 926);
        _inf_obj_value8=come_increment_ref_count(((struct sLShifEqualNode*)(right_value200=sLShifEqualNode_initialize((struct sLShifEqualNode*)come_increment_ref_count(((struct sLShifEqualNode*)(right_value199=(struct sLShifEqualNode*)come_calloc(1, sizeof(struct sLShifEqualNode)*(1), "19eq.c", 926)))),(struct sNode*)come_increment_ref_count(node),(struct sNode*)come_increment_ref_count(right_node_100),info))));
        ...
        _inf_value9=(struct sNode*)come_calloc(1, sizeof(struct sNode), "19eq.c", 934);
        _inf_obj_value9=come_increment_ref_count(((struct sRShiftEqualNode*)(right_value208=sRShiftEqualNode_initialize((struct sRShiftEqualNode*)come_increment_ref_count(((struct sRShiftEqualNode*)(right_value207=(struct sRShiftEqualNode*)come_calloc(1, sizeof(struct sRShiftEqualNode)*(1), "19eq.c", 934)))),(struct sNode*)come_increment_ref_count(node),(struct sNode*)come_increment_ref_count(right_node_102),info))));
        ...
        _inf_value10=(struct sNode*)come_calloc(1, sizeof(struct sNode), "19eq.c", 942);
        _inf_obj_value10=come_increment_ref_count(((struct sXorEqualNode*)(right_value216=sXorEqualNode_initialize((struct sXorEqualNode*)come_increment_ref_count(((struct sXorEqualNode*)(right_value215=(struct sXorEqualNode*)come_calloc(1, sizeof(struct sXorEqualNode)*(1), "19eq.c", 942)))),(struct sNode*)come_increment_ref_count(node),(struct sNode*)come_increment_ref_count(right_node_104),info))));
        ...
        _inf_value11=(struct sNode*)come_calloc(1, sizeof(struct sNode), "19eq.c", 950);
        _inf_obj_value11=come_increment_ref_count(((struct sAndEqualNode*)(right_value224=sAndEqualNode_initialize((struct sAndEqualNode*)come_increment_ref_count(((struct sAndEqualNode*)(right_value223=(struct sAndEqualNode*)come_calloc(1, sizeof(struct sAndEqualNode)*(1), "19eq.c", 950)))),(struct sNode*)come_increment_ref_count(node),(struct sNode*)come_increment_ref_count(right_node_106),info))));
        ...
        _inf_value12=(struct sNode*)come_calloc(1, sizeof(struct sNode), "19eq.c", 958);
        _inf_obj_value12=come_increment_ref_count(((struct sOrEqualNode*)(right_value232=sOrEqualNode_initialize((struct sOrEqualNode*)come_increment_ref_count(((struct sOrEqualNode*)(right_value231=(struct sOrEqualNode*)come_calloc(1, sizeof(struct sOrEqualNode)*(1), "19eq.c", 958)))),(struct sNode*)come_increment_ref_count(node),(struct sNode*)come_increment_ref_count(right_node_108),info))));
...
memset(&right_value150, 0, sizeof(void*));
            ...
            result_88=(struct sPlusPlusNode*)come_increment_ref_count(((struct sPlusPlusNode*)(right_value148=(struct sPlusPlusNode*)come_calloc(1, sizeof(struct sPlusPlusNode)*(1), "19eq.c", 874))));
...
memset(&right_value156, 0, sizeof(void*));
            ...
            result_89=(struct sMinusMinusNode*)come_increment_ref_count(((struct sMinusMinusNode*)(right_value154=(struct sMinusMinusNode*)come_calloc(1, sizeof(struct sMinusMinusNode)*(1), "19eq.c", 880))));
...
memset(&right_value164, 0, sizeof(void*));
            ...
            result_91=(struct sPlusEqualNode*)come_increment_ref_count(((struct sPlusEqualNode*)(right_value161=(struct sPlusEqualNode*)come_calloc(1, sizeof(struct sPlusEqualNode)*(1), "19eq.c", 888))));
...
memset(&right_value172, 0, sizeof(void*));
            ...
            result_93=(struct sMinusEqualNode*)come_increment_ref_count(((struct sMinusEqualNode*)(right_value169=(struct sMinusEqualNode*)come_calloc(1, sizeof(struct sMinusEqualNode)*(1), "19eq.c", 896))));
...
memset(&right_value180, 0, sizeof(void*));
            ...
            result_95=(struct sMultEqualNode*)come_increment_ref_count(((struct sMultEqualNode*)(right_value177=(struct sMultEqualNode*)come_calloc(1, sizeof(struct sMultEqualNode)*(1), "19eq.c", 904))));
...
memset(&right_value188, 0, sizeof(void*));
            ...
            result_97=(struct sDivEqualNode*)come_increment_ref_count(((struct sDivEqualNode*)(right_value185=(struct sDivEqualNode*)come_calloc(1, sizeof(struct sDivEqualNode)*(1), "19eq.c", 912))));
...
memset(&right_value196, 0, sizeof(void*));
            ...
            result_99=(struct sModEqualNode*)come_increment_ref_count(((struct sModEqualNode*)(right_value193=(struct sModEqualNode*)come_calloc(1, sizeof(struct sModEqualNode)*(1), "19eq.c", 920))));
...
memset(&right_value204, 0, sizeof(void*));
            ...
            result_101=(struct sLShifEqualNode*)come_increment_ref_count(((struct sLShifEqualNode*)(right_value201=(struct sLShifEqualNode*)come_calloc(1, sizeof(struct sLShifEqualNode)*(1), "19eq.c", 928))));
...
memset(&right_value212, 0, sizeof(void*));
            ...
            result_103=(struct sRShiftEqualNode*)come_increment_ref_count(((struct sRShiftEqualNode*)(right_value209=(struct sRShiftEqualNode*)come_calloc(1, sizeof(struct sRShiftEqualNode)*(1), "19eq.c", 936))));
...
memset(&right_value220, 0, sizeof(void*));
            ...
            result_105=(struct sXorEqualNode*)come_increment_ref_count(((struct sXorEqualNode*)(right_value217=(struct sXorEqualNode*)come_calloc(1, sizeof(struct sXorEqualNode)*(1), "19eq.c", 944))));
...
memset(&right_value228, 0, sizeof(void*));
            ...
            result_107=(struct sAndEqualNode*)come_increment_ref_count(((struct sAndEqualNode*)(right_value225=(struct sAndEqualNode*)come_calloc(1, sizeof(struct sAndEqualNode)*(1), "19eq.c", 952))));
...
memset(&right_value236, 0, sizeof(void*));
            ...
            result_109=(struct sOrEqualNode*)come_increment_ref_count(((struct sOrEqualNode*)(right_value233=(struct sOrEqualNode*)come_calloc(1, sizeof(struct sOrEqualNode)*(1), "19eq.c", 960))));
...
memset(&right_value244, 0, sizeof(void*));
            ...
            result_111=(struct sExpEqualNode*)come_increment_ref_count(((struct sExpEqualNode*)(right_value241=(struct sExpEqualNode*)come_calloc(1, sizeof(struct sExpEqualNode)*(1), "19eq.c", 968))));
