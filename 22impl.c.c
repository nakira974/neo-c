...
memset(&word_0, 0, sizeof(char*)); /* ddd */
memset(&right_value1, 0, sizeof(void*));
memset(&generics_name_3, 0, sizeof(char*)); /* ddd */
memset(&pointer_num_7, 0, sizeof(int)); /* ddd */
memset(&right_value5, 0, sizeof(void*));
memset(&right_value6, 0, sizeof(void*));
memset(&head_14, 0, sizeof(char*)); /* ddd */
memset(&right_value7, 0, sizeof(void*));
memset(&buf_15, 0, sizeof(char*)); /* ddd */
memset(&right_value8, 0, sizeof(void*));
memset(&node_16, 0, sizeof(struct sNode*)); /* ddd */
memset(&right_value9, 0, sizeof(void*));
memset(&right_value10, 0, sizeof(void*));
    if(string_operator_equals(buf,"impl")) {
        word_0=(char*)come_increment_ref_count(((char*)(right_value0=parse_word(info))));
        ...
        if(*info->p==60) {
            ...
            while((_Bool)1) {
                generics_name_3=(char*)come_increment_ref_count(((char*)(right_value1=parse_word(info))));
                if(right_value1) { right_value1 = come_decrement_ref_count(right_value1, (void*)0, (void*)0, 1, 0); }
                list$1charphp_push_back(info->generics_type_names,(char*)come_increment_ref_count(generics_name_3));
                if(*info->p==44) {
                    info->p++;
                    skip_spaces_and_lf(info);
                }
                ...
                if(generics_name_3) { generics_name_3 = come_decrement_ref_count(generics_name_3, (void*)0, (void*)0, 0, 0); }
            }
        }
        pointer_num_7=0;
        while(*info->p==42) {
        ...
        info->impl_type=(struct sType*)come_increment_ref_count(((struct sType*)(right_value6=sType_initialize((struct sType*)come_increment_ref_count(((struct sType*)(right_value5=(struct sType*)come_calloc(1, sizeof(struct sType)*(1))))),word_0,info,(_Bool)0))));
        ...
        info->impl_type->mPointerNum=pointer_num_7;
        while(*info->p!=125) {
            parse_sharp_v5(info);
            head_14=info->p;
            buf_15=(char*)come_increment_ref_count(((char*)(right_value7=parse_word(info))));
            if(right_value7) { right_value7 = come_decrement_ref_count(right_value7, (void*)0, (void*)0, 1, 0); }
            parse_sharp_v5(info);
            node_16=(struct sNode*)come_increment_ref_count(((struct sNode*)(right_value8=top_level_v99((char*)come_increment_ref_count(buf_15),head_14,head_sline,info))));
            if(right_value8) { right_value8 = come_decrement_ref_count(right_value8, ((struct sNode*)right_value8)->finalize, ((struct sNode*)right_value8)->_protocol_obj, 1, 0); } 
            parse_sharp_v5(info);
            while(*info->p==59) {
                info->p++;
                skip_spaces_and_lf(info);
            ...
            parse_sharp_v5(info);
            if(node_16!=((void*)0)) {
                if(!node_16->compile(node_16->_protocol_obj,info)) {
            ...
            parse_sharp_v5(info);
            skip_spaces_and_lf(info);
            if(buf_15) { buf_15 = come_decrement_ref_count(buf_15, (void*)0, (void*)0, 0, 0); }
            if(node_16) { node_16 = come_decrement_ref_count(node_16, ((struct sNode*)node_16)->finalize, ((struct sNode*)node_16)->_protocol_obj, 0, 0); } 
        }
        expected_next_character(125,info);
        list$1charphp_reset(info->generics_type_names);
        info->impl_type=((void*)0);
        struct sNode* __result7__ = (struct sNode*)((void*)0);
        if(word_0) { word_0 = come_decrement_ref_count(word_0, (void*)0, (void*)0, 0, 0); }
        return __result7__;
    }
    struct sNode* __result8__ = ((struct sNode*)(right_value10=top_level_v92((char*)come_increment_ref_count(((char*)(right_value9=__builtin_string(buf)))),head,head_sline,info)));
...
static void list$1charphp_reset(struct list$1charph* self){
struct list_item$1charph* it_1;
struct list_item$1charph* prev_it_2;
memset(&it_1, 0, sizeof(struct list_item$1charph*)); /* ddd */
memset(&prev_it_2, 0, sizeof(struct list_item$1charph*)); /* ddd */
                it_1=self->head;
                while(it_1!=((void*)0)) {
                    prev_it_2=it_1;
                    it_1=it_1->next;
                    if(prev_it_2) { come_call_finalizer(list_item$1charphp_finalize,prev_it_2, (void*)0, (void*)0, 0, 0, 0); }
                }
                self->head=((void*)0);
                self->tail=((void*)0);
                self->len=0;
...
static void list$1charphp_push_back(struct list$1charph* self, char* item){
void* right_value2;
struct list_item$1charph* litem_4;
char* __dec_obj1;
void* right_value3;
struct list_item$1charph* litem_5;
char* __dec_obj2;
void* right_value4;
struct list_item$1charph* litem_6;
char* __dec_obj3;
memset(&right_value2, 0, sizeof(void*));
memset(&litem_4, 0, sizeof(struct list_item$1charph*)); /* ddd */
memset(&right_value3, 0, sizeof(void*));
memset(&litem_5, 0, sizeof(struct list_item$1charph*)); /* ddd */
memset(&right_value4, 0, sizeof(void*));
memset(&litem_6, 0, sizeof(struct list_item$1charph*)); /* ddd */
                    if(self->len==0) {
                        litem_4=((struct list_item$1charph*)(right_value2=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1))));
                        litem_4->prev=((void*)0);
                        litem_4->next=((void*)0);
                        __dec_obj1=litem_4->item;
                        ...
                        litem_5=((struct list_item$1charph*)(right_value3=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1))));
                        ...
                        litem_6=((struct list_item$1charph*)(right_value4=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1))));
...
memset(&prev_it_9, 0, sizeof(struct list_item$1sTypeph*)); /* ddd */
                    it_8=self->head;
                    while(it_8!=((void*)0)) {
                        if(1) {
...
memset(&it_10, 0, sizeof(struct list_item$1sNodeph*)); /* ddd */
memset(&prev_it_11, 0, sizeof(struct list_item$1sNodeph*)); /* ddd */
                    it_10=self->head;
                    while(it_10!=((void*)0)) {
                        if(1) {
...
memset(&it_12, 0, sizeof(struct list_item$1charph*)); /* ddd */
memset(&prev_it_13, 0, sizeof(struct list_item$1charph*)); /* ddd */
                    it_12=self->head;
                    while(it_12!=((void*)0)) {
                        if(1) {
