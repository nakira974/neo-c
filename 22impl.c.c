...
memset(&word_0, 0, sizeof(char*));
memset(&right_value1, 0, sizeof(void*));
memset(&generics_name_3, 0, sizeof(char*));
memset(&pointer_num_7, 0, sizeof(int));
memset(&right_value5, 0, sizeof(void*));
memset(&right_value6, 0, sizeof(void*));
memset(&head_14, 0, sizeof(char*));
memset(&right_value7, 0, sizeof(void*));
memset(&buf_15, 0, sizeof(char*));
memset(&right_value8, 0, sizeof(void*));
memset(&node_16, 0, sizeof(struct sNode*));
...
memset(&right_value10, 0, sizeof(void*));
    if(string_operator_equals(buf,"impl")) {
        ...
        info->impl_type=(struct sType*)come_increment_ref_count(((struct sType*)(right_value6=sType_initialize((struct sType*)come_increment_ref_count(((struct sType*)(right_value5=(struct sType*)come_calloc(1, sizeof(struct sType)*(1), "22impl.c", 42)))),word_0,info,(_Bool)0))));
...
memset(&it_1, 0, sizeof(struct list_item$1charph*));
memset(&prev_it_2, 0, sizeof(struct list_item$1charph*));
                it_1=self->head;
                while(it_1!=((void*)0)) {
                    prev_it_2=it_1;
                    it_1=it_1->next;
...
memset(&litem_4, 0, sizeof(struct list_item$1charph*));
memset(&right_value3, 0, sizeof(void*));
memset(&litem_5, 0, sizeof(struct list_item$1charph*));
memset(&right_value4, 0, sizeof(void*));
memset(&litem_6, 0, sizeof(struct list_item$1charph*));
                    if(self->len==0) {
                        litem_4=((struct list_item$1charph*)(right_value2=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "22impl.c", 17)));
                        litem_4->prev=((void*)0);
                        litem_4->next=((void*)0);
                        ...
                        litem_5=((struct list_item$1charph*)(right_value3=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "22impl.c", 27)));
                        ...
                        litem_6=((struct list_item$1charph*)(right_value4=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "22impl.c", 37)));
