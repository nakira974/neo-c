...
const int GC_EVENT_START=0;
const int GC_EVENT_MARK_START=1;
const int GC_EVENT_MARK_END=2;
const int GC_EVENT_RECLAIM_START=3;
const int GC_EVENT_RECLAIM_END=4;
const int GC_EVENT_END=5;
const int GC_EVENT_PRE_STOP_WORLD=6;
const int GC_EVENT_POST_STOP_WORLD=7;
const int GC_EVENT_PRE_START_WORLD=8;
const int GC_EVENT_POST_START_WORLD=9;
const int GC_EVENT_THREAD_SUSPENDED=10;
const int GC_EVENT_THREAD_UNSUSPENDED=11;
...
const int GC_TOGGLE_REF_DROP=0;
const int GC_TOGGLE_REF_STRONG=1;
const int GC_TOGGLE_REF_WEAK=2;
