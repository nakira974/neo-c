...
static char tok_two_chars[123] = "<=\236>=\235!=\225&&\240||\241++\244--\242==\224<<\1>>\2+=\253-=\255*=\252/=\257%=\245&=\246^=\336|=\374->\313..\250##\266";
...
int main(){
    ...
    memset(&objfilename, 0, sizeof(char));
    outfile=objfilename;
    const unsigned char* q;
    memset(&q, 0, sizeof(const unsigned char*));
    q=tok_two_chars;
    union X x;
    memset(&x, 0, sizeof(union X));
