...
int is_cleared(const WINDOW* );
int is_idcok(const WINDOW* );
int is_idlok(const WINDOW* );
int is_immedok(const WINDOW* );
int is_keypad(const WINDOW* );
int is_leaveok(const WINDOW* );
int is_nodelay(const WINDOW* );
int is_notimeout(const WINDOW* );
int is_pad(const WINDOW* );
int is_scrollok(const WINDOW* );
int is_subwin(const WINDOW* );
int is_syncok(const WINDOW* );
int wgetdelay(const WINDOW* );
int wgetscrreg(const WINDOW* , int* , int* );
SCREEN* new_prescr();
int baudrate_sp(SCREEN* );
int beep_sp(SCREEN* );
int can_change_color_sp(SCREEN* );
...
int has_colors_sp(SCREEN* );
int has_ic_sp(SCREEN* );
int has_il_sp(SCREEN* );
int init_color_sp(SCREEN* , short , short , short , short );
int init_pair_sp(SCREEN* , short , short , short );
int intrflush_sp(SCREEN* , WINDOW* , int );
int isendwin_sp(SCREEN* );
...
void use_env_sp(SCREEN* , int );
void use_tioctl_sp(SCREEN* , int );
...
int is_term_resized_sp(SCREEN* , int , int );
int key_defined_sp(SCREEN* , const char* );
int keyok_sp(SCREEN* , int , int );
...
int wenclose(const WINDOW* , int , int );
int mouseinterval(int );
int wmouse_trafo(const WINDOW* , int* , int* , int );
int mouse_trafo(int* , int* , int );
int has_mouse_sp(SCREEN* );
...
unsigned int bool_get_hash_key(int value);
int bool_equals(int left, int right);
unsigned int string_get_hash_key(char* value);
int string_equals(char* left, char* right);
...
int bool_except(int self, void* parent, void (*block)(void*));
int bool_if(int self, void* parent, void (*block)(void*));
...
struct regex_struct* regex(char* str, int ignore_case, int multiline, int global, int extended, int dotall, int anchored, int dollar_endonly, int ungreedy);
int charp_match(char* self, struct regex_struct* reg);
...
struct regex_struct* charp_to_regex_flags(char* self, int global, int ignore_case);
...
int charp_match_count(char* self, struct regex_struct* reg, int count);
...
int regex_structp_equals(struct regex_struct* left, struct regex_struct* right);
...
int wchar_t_equals(int left, int right);
unsigned int wchar_tp_get_hash_key(int* value);
int wchar_tp_equals(int* left, int* right);
unsigned int regex_structp_get_hash_key(struct regex_struct* self);
int charp_match_group_strings(char* self, struct regex_struct* reg, int count, struct list_charphp* group_strings);
char* charp_operator_mult(char* str, int n);
char* string_operator_mult(char* str, int n);
int* wchar_tp_operator_mult(int* str, int n);
int* wstring_operator_mult(int* str, int n);
int charp_operator_equals(char* left, char* right);
int string_operator_equals(char* left, char* right);
int wchar_tp_operator_equals(int* left, int* right);
int wstring_operator_equals(int* left, int* right);
...
static int map_equals_charp_int(struct map_charpp_int* left, struct map_charpp_int* right);
...
inline_func_end_label1:
    ...
    char* a=(right_value0 = (xsprintf("AAA")));
    {
    const char* _inline_msg1 = "xsprintf test";
    int _inline_exp1 = (strcmp((right_value1 = (xsprintf("AAA"))),"AAA"))==0;
        (printf("%s",_inline_msg1));
        (printf("..."));
        if(_inline_exp1) {
            (puts("ok"));
...
inline_func_end_label2:
    ...
    {
    const char* _inline_msg1 = "xsprintf test";
    int _inline_exp1 = (strcmp((right_value2 = (xsprintf("%d%d",1,1))),"11"))==0;
        (printf("%s",_inline_msg1));
        (printf("..."));
        if(_inline_exp1) {
            (puts("ok"));
...
inline_func_end_label3:
    ...
    int _inline_exp1 = (strcmp((right_value3 = (__builtin_string("AAA"))),"AAA"))==0;
        (printf("%s",_inline_msg1));
        (printf("..."));
        if(_inline_exp1) {
            (puts("ok"));
...
inline_func_end_label5:
    ...
    int _inline_exp1 = (strcmp(inline_result_variable5,"CBA"))==0;
        (printf("%s",_inline_msg1));
        (printf("..."));
        if(_inline_exp1) {
            (puts("ok"));
...
inline_func_end_label7:
    ...
    int _inline_exp1 = (strcmp(inline_result_variable7,"A"))==0;
        (printf("%s",_inline_msg1));
        (printf("..."));
        if(_inline_exp1) {
            (puts("ok"));
...
inline_func_end_label8:
    ...
    struct vector_int* v=(right_value10 = (vector_initialize_int((right_value8 = igc_calloc(1,24)))));
    (vector_push_back_int(v,1));
    (vector_push_back_int(v,2));
    (vector_push_back_int(v,3));
    {
    const char* _inline_msg1 = "vector test1";
    int _inline_exp1 = (vector_item_int(v,0,-1))==1&&(vector_item_int(v,1,-1))==2&&(vector_item_int(v,2,-1))==3&&(vector_item_int(v,100,-1))==-1&&(vector_length_int(v))==3;
        (printf("%s",_inline_msg1));
        (printf("..."));
        if(_inline_exp1) {
            (puts("ok"));
...
inline_func_end_label9:
    ...
    int _inline_exp1 = (vector_item_int(v,0,-1))==7;
        (printf("%s",_inline_msg1));
        (printf("..."));
        if(_inline_exp1) {
            (puts("ok"));
...
inline_func_end_label10:
...
}
    {
        ...
        while(!(vector_end_int(_obj))) {
            (printf("%d\n",it));
            it=(vector_next_int(_obj));
        }
    }
    struct list_int* l=(right_value12 = (list_initialize_int((right_value11 = igc_calloc(1,32)))));
    {
    const char* _inline_msg1 = "list test1";
    int _inline_exp1 = (list_length_int(l))==0;
        (printf("%s",_inline_msg1));
        (printf("..."));
        if(_inline_exp1) {
            (puts("ok"));
...
inline_func_end_label11:
    ...
    int _inline_exp1 = (list_length_int(l))==3&&(list_item_int(l,0,-1))==1&&(list_item_int(l,1,-1))==2&&(list_item_int(l,2,-1))==3;
        (printf("%s",_inline_msg1));
        (printf("..."));
        if(_inline_exp1) {
            (puts("ok"));
...
inline_func_end_label12:
    ...
    int _inline_exp1 = (list_length_int(l))==4&&(list_item_int(l,0,-1))==0&&(list_item_int(l,1,-1))==1&&(list_item_int(l,2,-1))==2&&(list_item_int(l,3,-1))==3;
        (printf("%s",_inline_msg1));
        (printf("..."));
        if(_inline_exp1) {
            (puts("ok"));
...
inline_func_end_label14:
    ...
    int _inline_exp1 = (list_length_int(l))==3&&(list_item_int(l,0,-1))==7&&(list_item_int(l,1,-1))==2&&(list_item_int(l,2,-1))==3;
        (printf("%s",_inline_msg1));
        (printf("..."));
        if(_inline_exp1) {
            (puts("ok"));
...
inline_func_end_label19:
    ...
    int _inline_exp1 = (map_at_charph_int(m,"AAA",-1))==1&&(map_at_charph_int(m,"BBB",-1))==2&&(map_at_charph_int(m,"CCC",-1))==3;
        (printf("%s",_inline_msg1));
        (printf("..."));
        if(_inline_exp1) {
            (puts("ok"));
...
inline_func_end_label20:
    ...
    int _inline_exp1 = t->v1==123&&t->v2=="ABC";
        (printf("%s",_inline_msg1));
        (printf("..."));
        if(_inline_exp1) {
            (puts("ok"));
...
inline_func_end_label22:
    ...
    int _inline_exp1 = (map_at_charp_int(m1,"AAA",-1))==1;
        (printf("%s",_inline_msg1));
        (printf("..."));
        if(_inline_exp1) {
            (puts("ok"));
...
inline_func_end_label23:
    ...
    {
    const char* _inline_msg1 = "map test2";
    int _inline_exp1 = (map_at_charp_int(m2,"AAA",-1))==1;
        (printf("%s",_inline_msg1));
        (printf("..."));
        if(_inline_exp1) {
            (puts("ok"));
...
inline_func_end_label24:
    ...
    {
    const char* _inline_msg1 = "map test3";
    int _inline_exp1 = (map_equals_charp_int(m1,m2));
        (printf("%s",_inline_msg1));
        (printf("..."));
        if(_inline_exp1) {
            (puts("ok"));
...
static void vector_push_back_int(struct vector_int* self, int item)
{
    if(self->len==self->size) {
        ...
        self->items=(igc_calloc(1,sizeof(int)*new_size));
        int i;
