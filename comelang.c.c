...
void free_object(void* mem)
{
if(((void*)mem)==(((void*)((void*)0)))) {
}
int* ref_count=((int*)((int*)((int*)(((char*)((char*)mem))-sizeof(int)-sizeof(long)))));
(ncfree(ref_count));
}
...
if(((int)(call_finalizer_only!=0))) {
if(((int)(fun!=0))) {
void (*finalizer)(void*)=((lambda*)fun);
finalizer(mem);
}
}
else {
...
void* nccalloc(long nmemb, long size)
{
void* result=((void*)(calloc(nmemb,size)));
return ((void*)result);
}
...
char* mem=((char*)((char*)((char*)block))-sizeof(int)-sizeof(long));
long* size_p=((long*)((long*)((long*)(mem+sizeof(int)))));
long size=*size_p;
...
*(&(*ref_count))=1;;
1;
long* size_p2=((long*)((long*)((long*)(((char*)((char*)ret))+sizeof(int)))));
*size_p2=size;;
size;
return ((void*)((char*)((char*)ret))+sizeof(int)+sizeof(long));
}

void* call_cloner(void* fun, void* mem)
{
if(((int)(fun!=0))&&((int)(mem!=0))) {
void* (*cloner)(void*)=((lambda*)fun);
return ((void*)cloner(mem));
}
return ((void*)((void*)0));
}
