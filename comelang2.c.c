...
void* gc_nccalloc(unsigned long nmemb, unsigned long size);
void* gc_ncmemdup(void* block);

void* gc_nccalloc(unsigned long nmemb, unsigned long size)
{
    void* __tmp_variable1 = (GC_malloc(nmemb*size));
    void* result__1=__tmp_variable1;
...
void* gc_ncmemdup(void* block)
{
    ...
    if(!(GC_is_heap_ptr(block))) {
                void* __result_value = block;
        return __result_value;
    }
    unsigned long __tmp_variable2 = (GC_size(block));
    unsigned long size__1=__tmp_variable2;
    void* __tmp_variable3 = (GC_malloc(size__1));
    void* ret__1=__tmp_variable3;
    if(ret__1) {
        char* __tmp_variable4 = ret__1;
        char* p__2=__tmp_variable4;
        char* __tmp_variable5 = block;
        char* p2__2=__tmp_variable5;
        while (p__2-((char*)ret__1)<size__1) {
            *p__2=*p2__2;
            char* __tmp_variable6 = p__2+1;
            p__2=__tmp_variable6;
            char* __tmp_variable7 = p2__2+1;
            p2__2=__tmp_variable7;
        }
    }
        void* __result_value = ret__1;
    return __result_value;
}
