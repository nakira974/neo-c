...
struct __current_stack1__
{
    int* argc;
    char*** argv;
    struct list_int** __list_value1___29;
};
...
void* right_value2;
    unsigned int __result__ = stringp_get_hash_key((char*)(right_value2=__builtin_string(value)));
    return __result__;
...
static struct map_char_int* map_char_intp_initialize(struct map_char_int* self);
...
static void map_char_intp_finalize(struct map_char_int* self);
static void map_char_intp_insert(struct map_char_int* self, char* key, int item);
...
void* right_value8;
void* right_value14;
struct map_char_int* m_41;
memset(&__list_value1___29, 0, sizeof(struct list_int*));
memset(&m_41, 0, sizeof(struct map_char_int*));
    __init_a_c__();
    __list_value1___29=come_increment_ref_count((struct list_int*)(right_value4=list_intp_initialize(come_increment_ref_count((struct list_int*)(right_value3=(struct list_int*)come_calloc(1, sizeof(struct list_int)*1))))));
    call_finalizer(list_intp_finalize,right_value3,0, 1, 0);
    list_intp_push_back(__list_value1___29,1);
    list_intp_push_back(__list_value1___29,2);
    list_intp_push_back(__list_value1___29,3);
    list_intp_push_back(__list_value1___29,4);
    list_intp_push_back(__list_value1___29,5);
    __current_stack1__.argc = &argc;
    __current_stack1__.argv = &argv;
    __current_stack1__.__list_value1___29 = &__list_value1___29;
    list_intp_each(__list_value1___29,&__current_stack1__,method_block1);
    m_41=come_increment_ref_count((struct map_char_int*)(right_value14=map_char_intp_initialize(come_increment_ref_count((struct map_char_int*)(right_value8=(struct map_char_int*)come_calloc(1, sizeof(struct map_char_int)*1))))));
    call_finalizer(map_char_intp_finalize,right_value8,0, 1, 0);
}
...
static void list_intp_finalize(struct list_int* self){
struct list_item_int* it_27;
struct list_item_int* prev_it_28;
memset(&it_27, 0, sizeof(struct list_item_int*));
memset(&prev_it_28, 0, sizeof(struct list_item_int*));
            it_27=self->head;
            while(it_27!=((void*)0)) {
                if(0) {
                }
                prev_it_28=it_27;
                it_27=it_27->next;
                call_finalizer(list_item_intp_finalize,prev_it_28,0, 0, 0);
            }
}
...
static void list_intp_push_back(struct list_int* self, int item){
void* right_value5;
struct list_item_int* litem_30;
void* right_value6;
struct list_item_int* litem_31;
void* right_value7;
struct list_item_int* litem_32;
memset(&litem_30, 0, sizeof(struct list_item_int*));
memset(&litem_31, 0, sizeof(struct list_item_int*));
memset(&litem_32, 0, sizeof(struct list_item_int*));
        if(self->len==0) {
            litem_30=(struct list_item_int*)(right_value5=(struct list_item_int*)come_calloc(1, sizeof(struct list_item_int)*1));
            ...
            litem_31=(struct list_item_int*)(right_value6=(struct list_item_int*)come_calloc(1, sizeof(struct list_item_int)*1));
            ...
            litem_32=(struct list_item_int*)(right_value7=(struct list_item_int*)come_calloc(1, sizeof(struct list_item_int)*1));
...
static void list_intp_each(struct list_int* self, void* parent, void (*block)(void*,int,int,_Bool*)){
struct list_item_int* it_33;
int i_34;
_Bool end_flag_35;
memset(&it_33, 0, sizeof(struct list_item_int*));
memset(&i_34, 0, sizeof(int));
memset(&end_flag_35, 0, sizeof(_Bool));
        it_33=self->head;
        i_34=0;
        while(it_33!=((void*)0)) {
            end_flag_35=(_Bool)0;
            block(parent,it_33->item,i_34,&end_flag_35);
            if(end_flag_35==(_Bool)1) {
                break;
            }
            it_33=it_33->next;
            i_34++;
...
memset(&i_36, 0, sizeof(int));
        self->keys=(char***)(right_value9=(char***)come_calloc(1, sizeof(char**)*1*128));
        self->items=(int**)(right_value10=(int**)come_calloc(1, sizeof(int*)*1*128));
        self->item_existance=(_Bool**)(right_value11=(_Bool**)come_calloc(1, sizeof(_Bool*)*1*128));
        for(
        i_36=0;
        i_36<128;
        i_36++
        ){
            self->item_existance[i_36]=(_Bool)0;
        }
        self->size=128;
        self->len=0;
        come_decrement_ref_count(self->key_list, 0, 0);
        self->key_list=come_increment_ref_count((struct list_char*)(right_value13=list_charp_initialize(come_increment_ref_count((struct list_char*)(right_value12=(struct list_char*)come_calloc(1, sizeof(struct list_char)*1))))));
        call_finalizer(list_charp_finalize,right_value12,0, 1, 0);
        self->it=0;
        struct map_char_int* __result__ = self;
        call_finalizer(map_char_intp_finalize,self,0, 0, 1);
        return __result__;
}
...
static void list_charp_finalize(struct list_char* self){
struct list_item_char* it_37;
struct list_item_char* prev_it_38;
memset(&it_37, 0, sizeof(struct list_item_char*));
memset(&prev_it_38, 0, sizeof(struct list_item_char*));
                it_37=self->head;
                while(it_37!=((void*)0)) {
                    if(0) {
                        it_37->item = come_decrement_ref_count(it_37->item, 0, 0);
                    }
                    prev_it_38=it_37;
                    it_37=it_37->next;
                    call_finalizer(list_item_charp_finalize,prev_it_38,0, 0, 0);
                }
}
...
memset(&i_40, 0, sizeof(int));
            ...
            i_40++
                ...
                if(self->item_existance[i_40]) {
                    if(1) {
                        self->keys[i_40] = come_decrement_ref_count(self->keys[i_40], 0, 0);
                    }
                }
            }
            come_free_object((char*)self->keys);
            call_finalizer(list_charp_finalize,self->key_list,0, 0, 0);
