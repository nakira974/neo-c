...
void* right_value2;
    ...
    char* __tmp_variable1 = (right_value2 = igc_calloc(len,1));
...
void* right_value11;
    ...
    char* str=reg->str;
    pcre* re=reg->re;
    struct buffer* __tmp_variable2 = (right_value4 = (bufferp_initialize((right_value3 = igc_calloc(1,16)))));
    struct buffer* result=__tmp_variable2;
    while (1) {
        int options__2=2097152;
        int len=(strlen(self));
        int regex_result=(pcre_exec(re,((pcre_extra*)0),self,len,offset,options__2,ovec_value,ovec_max*3));
...
inline_func_end_label1:
            ...
            char* __tmp_variable3 = inline_result_variable1;
            char* str__3=__tmp_variable3;
            (bufferp_append_str(result,str__3));
            (bufferp_append_str(result,replace));
            if(offset==end[0]) {
                offset=offset+1;
            }
            else {
...
inline_func_end_label2:
                ...
                char* __tmp_variable4 = inline_result_variable2;
                char* str__4=__tmp_variable4;
                (bufferp_append_str(result,str__4));
...
inline_func_end_label3:
            ...
            char* __tmp_variable5 = inline_result_variable3;
        ...
        char* __result_value = (right_value11 = (bufferp_to_string(result)));
    call_finalizer(buffer_finalize,result,0);
    return __result_value;
}
...
void* right_value22;
    ...
    char* str=reg->str;
    pcre* re=reg->re;
    struct buffer* __tmp_variable6 = (right_value13 = (bufferp_initialize((right_value12 = igc_calloc(1,16)))));
    struct buffer* result=__tmp_variable6;
    int n=0;
    while (1) {
        int options__2=2097152;
        int len=(strlen(self));
...
inline_func_end_label4:
            ...
            char* __tmp_variable7 = inline_result_variable4;
            char* str__3=__tmp_variable7;
            (bufferp_append_str(result,str__3));
            (bufferp_append_str(result,replace));
            if(offset==end[0]) {
                offset=offset+1;
...
inline_func_end_label5:
                ...
                char* __tmp_variable8 = inline_result_variable5;
                char* str__4=__tmp_variable8;
                (bufferp_append_str(result,str__4));
                igc_decrement_ref_count(str__4);
                igc_decrement_ref_count(str__3);
                break;
...
inline_func_end_label6:
                ...
                char* __tmp_variable9 = inline_result_variable6;
                char* str__4=__tmp_variable9;
                (bufferp_append_str(result,str__4));
                igc_decrement_ref_count(str__4);
                igc_decrement_ref_count(str__3);
                break;
...
inline_func_end_label7:
            ...
            char* __tmp_variable10 = inline_result_variable7;
        ...
        char* __result_value = (right_value22 = (bufferp_to_string(result)));
    call_finalizer(buffer_finalize,result,0);
    return __result_value;
}
...
void* right_value27;
void* right_value31;
    struct list_charphp* __tmp_variable11 = (right_value24 = (list_initialize_charph((right_value23 = igc_calloc(1,32)))));
    struct list_charphp* result=__tmp_variable11;
    struct buffer* __tmp_variable12 = (right_value26 = (bufferp_initialize((right_value25 = igc_calloc(1,16)))));
    struct buffer* buf=__tmp_variable12;
    {
        int i=0;
        {
        char* _inline_str1 = self;
...
inline_func_end_label8:
        ...
        for(;i<inline_result_variable8;        i=i+1          ) {
            if((strstr(self+i,str))==self+i) {
                (list_push_back_charph(result,(right_value27 = (__builtin_string(buf->buf)))));
                (bufferp_reset(buf));
                i=i+(strlen(str))-1;
            }
            else {
                (bufferp_append_char(buf,self[i]));
            }
        }
    }
    if((bufferp_length(buf))!=0) {
        (list_push_back_charph(result,(right_value31 = (__builtin_string(buf->buf)))));
    }
...
void* right_value30;
    if(self->len==0) {
        struct list_item_charphp* litem=(right_value28 = igc_calloc(1,24));
        ...
        struct list_item_charphp* litem=(right_value29 = igc_calloc(1,24));
        ...
        struct list_item_charphp* litem=(right_value30 = igc_calloc(1,24));
...
void* right_value36;
void* right_value37;
    struct list_charphp* __tmp_variable13 = (right_value33 = (list_initialize_charph((right_value32 = igc_calloc(1,32)))));
    struct list_charphp* result=__tmp_variable13;
    struct buffer* __tmp_variable14 = (right_value35 = (bufferp_initialize((right_value34 = igc_calloc(1,16)))));
    struct buffer* str=__tmp_variable14;
    {
        int i=0;
        {
        char* _inline_str1 = self;
...
inline_func_end_label9:
        ...
        for(;i<inline_result_variable9;        i=i+1          ) {
            if(self[i]==c) {
                (list_push_back_charph(result,(right_value36 = (__builtin_string(str->buf)))));
                (bufferp_reset(str));
            }
            else {
                (bufferp_append_char(str,self[i]));
            }
        }
    }
    if((bufferp_length(str))!=0) {
        (list_push_back_charph(result,(right_value37 = (__builtin_string(str->buf)))));
    }
        struct list_charphp* __result_value = result;
    call_finalizer(buffer_finalize,str,0);
    return __result_value;
}
...
void* right_value44;
void* right_value45;
    struct list_charphp* __tmp_variable15 = (right_value39 = (list_initialize_charph((right_value38 = igc_calloc(1,32)))));
    struct list_charphp* result=__tmp_variable15;
    int offset=0;
    int ovec_max=16;
    int start[ovec_max];
    memset(&start, 0, sizeof(int));
...
inline_func_end_label10:
            ...
            char* __tmp_variable16 = inline_result_variable10;
            char* str__3=__tmp_variable16;
...
inline_func_end_label11:
            ...
            char* __tmp_variable17 = inline_result_variable11;
            char* str__3=__tmp_variable17;
            igc_increment_ref_count(str__3);
            (list_push_back_charph(result,str__3));
            if(offset==end[0]) {
                offset=offset+1;
...
inline_func_end_label12:
                    ...
                    char* __tmp_variable18 = inline_result_variable12;
                    char* match_string=__tmp_variable18;
                    igc_increment_ref_count(match_string);
                    (list_push_back_charph(result,match_string));
...
void* right_value57;
    ...
    char* str=reg->str;
    pcre* re=reg->re;
    struct list_charphp* __tmp_variable19 = (right_value49 = (list_initialize_charph((right_value48 = igc_calloc(1,32)))));
    struct list_charphp* result=__tmp_variable19;
    int offset=0;
    int ovec_max=16;
    int start[ovec_max];
    memset(&start, 0, sizeof(int));
...
inline_func_end_label13:
            ...
            char* __tmp_variable20 = inline_result_variable13;
            char* str__3=__tmp_variable20;
            igc_increment_ref_count(str__3);
            (list_push_back_charph(result,str__3));
            if(offset==end[0]) {
                offset=offset+1;
...
inline_func_end_label14:
            ...
            char* __tmp_variable21 = inline_result_variable14;
...
inline_func_end_label15:
                    ...
                    char* __tmp_variable22 = inline_result_variable15;
                    char* match_str=__tmp_variable22;
                    igc_increment_ref_count(match_str);
                    (list_push_back_charph(result,match_str));
...
inline_func_end_label16:
    ...
    if(offset<inline_result_variable16) {
        {
        char* _inline_str1 = self;
        int _inline_head1 = offset;
        int _inline_tail1 = -1;
...
inline_func_end_label17:
        ...
        char* __tmp_variable23 = inline_result_variable17;
        char* str__2=__tmp_variable23;
        igc_increment_ref_count(str__2);
        (list_push_back_charph(result,str__2));
...
void* right_value67;
    ...
    char* str=reg->str;
    pcre* re=reg->re;
    struct list_charphp* __tmp_variable24 = (right_value59 = (list_initialize_charph((right_value58 = igc_calloc(1,32)))));
    struct list_charphp* result=__tmp_variable24;
    int offset=0;
    int ovec_max=16;
    int start[ovec_max];
    memset(&start, 0, sizeof(int));
...
inline_func_end_label18:
            ...
            char* __tmp_variable25 = inline_result_variable18;
...
inline_func_end_label19:
            ...
            char* __tmp_variable26 = inline_result_variable19;
            char* str__3=__tmp_variable26;
            igc_increment_ref_count(str__3);
            (list_push_back_charph(result,str__3));
            if(offset==end[0]) {
                offset=offset+1;
...
inline_func_end_label20:
                    ...
                    char* __tmp_variable27 = inline_result_variable20;
                    char* match_str=__tmp_variable27;
                    igc_increment_ref_count(match_str);
                    (list_push_back_charph(result,match_str));
                    igc_decrement_ref_count(match_str);
                }
...
inline_func_end_label21:
    ...
    if(offset<inline_result_variable21) {
        {
        char* _inline_str1 = self;
        int _inline_head1 = offset;
        int _inline_tail1 = -1;
...
inline_func_end_label22:
        ...
        char* __tmp_variable28 = inline_result_variable22;
        char* str__2=__tmp_variable28;
        igc_increment_ref_count(str__2);
        (list_push_back_charph(result,str__2));
        igc_decrement_ref_count(str__2);
    }
