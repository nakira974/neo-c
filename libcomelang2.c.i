...
{
    if(mem == 
# 64 "libcomelang2.c" 3 4
             ((void *)0)
# 64 "libcomelang2.c"
                 ) {
        return 
# 65 "libcomelang2.c" 3 4
              ((void *)0)
# 65 "libcomelang2.c"
                  ;
    }
...
string FILE*::read(FILE* f)
{
    ...
    while(1) {
        char buf2[
# 524 "libcomelang2.c" 3 4
                 8192
# 524 "libcomelang2.c"
                       ];

        int size = fread(buf2, 1, 
# 526 "libcomelang2.c" 3 4
                                 8192
# 526 "libcomelang2.c"
                                       , f);
...
list<string>*% FILE*::readlines(FILE* f)
{
    ...
    while(1) {
        char buf[
# 929 "libcomelang2.c" 3 4
                8192
# 929 "libcomelang2.c"
                      ];

        if(fgets(buf, 
# 931 "libcomelang2.c" 3 4
                     8192
# 931 "libcomelang2.c"
                           , f) == 
# 931 "libcomelang2.c" 3 4
...
string FILE*::read(FILE* f)
{
    ...
    while(1) {
        char buf2[
# 946 "libcomelang2.c" 3 4
                 8192
# 946 "libcomelang2.c"
                       ];

        int size = fread(buf2, 1, 
# 948 "libcomelang2.c" 3 4
                                 8192
# 948 "libcomelang2.c"
                                       , f);
